          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Vicky Form</h3>
              </div>
            </div>
                            ...
                            <table id="tablin" class="table table-striped table-bordered bulk_action">
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  $sql = "select * from productos_vicky ";
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                    echo "<tr>";
                                      ...
                                      if($reportes==2 || $reportes ==1){                                     
                                        echo "<th><a href='acciones_vicky.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                        </th>";
                                      }else{
                                        echo "<th><a href='plus_vicky.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                        </th>";
                                      }
                                    echo "</tr>";
                                  }
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosVickyForm_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosVickyForm_"+fechita+".pdf"
