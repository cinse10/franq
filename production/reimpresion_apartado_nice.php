                              ...
                              <table id="tabla_tickets" class="table table-striped table-bordered bulk_action">
                                ...
                                <tbody>
                                  <?php 
                                    ...
                                    $sql = "SELECT * FROM `apartado_nice` INNER JOIN empleados ON apartado_nice.id_empledo=empleados.id_empleado ORDER BY fecha_ticket DESC";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      ...
                                      if ($resta!=0) {
                                        ...
                                        echo "<th><button class='btn btn-default btn-sm' onclick='checaTicket(".$reg["id_ticket"].");'><i class='fa fa-print'></i></button> 
                                          <a  href='ver_abonos_nice.php?id_ticket=".$reg["id_ticket"]."' class='btn btn-default btn-sm'><i class='fa fa-paste'></i></a>&nbsp
                                  ...
                                  <?php 
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      ...
                                      if ($resta==0) {
                                        ...
                                        echo "<th>$ ".$reg['total_ticket']."</th>";
                                        echo "<th><button class='btn btn-default btn-sm' onclick='checaTicket(".$reg["id_ticket"].");'><i class='fa fa-print'></i></button> 
                                          <a  href='ver_abonos_nice2.php?id_ticket=".$reg["id_ticket"]."' class='btn btn-default btn-sm'><i class='fa fa-paste'></i></a>&nbsp
