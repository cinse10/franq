<?php 
	if (isset($_GET['id_producto'])&& isset($_GET['action'])) {
		...
		if ($action=="edita") {			
			...
			$sql = "select * from productos_importados WHERE id_producto=".$id_producto;
			            ...
			            <div class="row">
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  ...
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_producto_importados.php">
				                    ...
				                    <div class="form-group">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input type="text" name="marca"  class="form-control col-md-7 col-xs-12" value="<?php echo $marca; ?>">
				                        </div>
				                      </div>
				                      <div class="form-group">
