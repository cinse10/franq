<?php 
  ...
  $kuerito =  "Select * from productos_bike";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_bike set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                              ...
                              <?php 
                                  include("conexion.php");
                                  $productos = mysqli_query($conexion,"SELECT * FROM `productos_bike` where inventario_producto != 0 ");
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12"><button class="btn btn-primary" onclick="cantidad();">Agregar</button></div>
                        </div>
                      <br><br>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "Select * from socios where id_socio = 1 or id_socio = 137 or id_socio = 164 or id_socio = 249 or id_socio = 410 OR id_socio = 411 OR id_socio=408 OR id_socio=703 ";
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_bike.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
...
//ACTUALIZA PRODUCTO ML AL HACER UNA VENTA
  function actualizaMl(id_producto){
    ...
    $.ajax({
      url: "./conector_ml/actualiza_bike_ventaMl.php",
      type: "POST",
  ...
  function actualizaLinio(id_producto){
    ...
    $.ajax({
      url: "./conector_linio/actualiza_bike_venta.php",
      type: "POST",
      data:{id_producto: objeto[i].firstElementChild.textContent},       
