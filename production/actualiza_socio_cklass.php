<?php 
	...
	if(mysqli_query($conexion,$SQL)){
			...
			$SQL2 = "UPDATE compras_cklass SET monto_mensual='".$ventas."', tipo_desc=".$tipo_desc." WHERE id_socio=".$id_socio;
			if(mysqli_query($conexion,$SQL2)){
				echo '<script language="javascript">';
					echo 'alert("Socio actualizado con éxito.");';
					echo "window.location='consulta_socios_cklass.php';";
				echo '</script>';
			}else{
				echo '<script language="javascript">';
