          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Reporte ventas Facturados</h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                      <label class="control-label col-md-1 col-sm-3 col-xs-12"   for="first-name">Tipo pago:  <span class="required">*</span>
                      </label>
                       <select class="form control selectpicker" data-show-subtext="true" data-live-search="true" name="pago" id="selectpago" onchange="checa()">      
                      ...
                      <button onclick="exportTableToExcel('tabla_reporte')" class="btn btn-primary" style="float: right;">Imprimir Excel</button>
          ...
          <div class="modal-dialog modal-sm" role="document" style="width:1000px;">
            <div class="modal-content" >
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Facturados</h4>
              </div>
              <div class="modal-body">
                <div id="impresion"></div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" id="guardarnuevo" onclick="imprimeTicket()">Imprimirr</button>                                   
              </div>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  function exportTableToExcel(tabla, filename = ''){
    ...
    // Specify file name
    filename = filename?filename+'.xls':'reporte_facturado'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
  ...
  function checa() {
     funsiona(document.getElementById("fecha1").value,document.getElementById("fecha2").value,document.getElementById("selectpago").value)
   ...
   var fin = document.getElementById("fecha2").value
    ...
    $.ajax({
      type: "POST",
      url: "trae_reporte_facturado.php",
...
/*
  function pago(selectPago){
    var select = document.getElementById("selectpago").value;
    console.log(select)
  ...
  //}
  function funsiona(inicio,fin,fpago) {
    
    var select = document.getElementById("socio"); //El <select>
    var value = select.value; //El valor seleccionado
    empleado=value;
    console.log("Fecha inicio: "+ inicio+" Fecha fin: "+fin + "formaPago:" + fpago);
     $.ajax({
      type: "POST",
      url: "trae_reporte_facturado.php",
      data: {'fecha_inicio': inicio, 'fecha_fin': fin,'id_empleado':empleado,'fpago':fpago},  
      success: function(data){ 
...
$(function() {
    ...
    const cook2 = document.cookie.includes('id_empleado_gym=6');
   
    if(cook === true || cook2 === true){
