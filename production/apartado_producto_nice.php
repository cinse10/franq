 <?php 
  ...
  $kuerito =  "Select * from productos_nice";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_nice set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar()">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                              ...
                              <?php 
                                  include("conexion.php");
                                  $productos = mysqli_query($conexion,"SELECT * FROM `productos_nice` where inventario_producto != 0 ");
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "Select * from socios_nice where id_socio = 1 or id_socio = 2 or id_socio = 3 or id_socio = 4";
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_nice.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
