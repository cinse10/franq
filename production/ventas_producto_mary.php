 <?php 
  ...
  $kuerito =  "Select * from productos_marykay";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_marykay set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                              ...
                              <?php 
                                  include("conexion.php");
                                  $productos = mysqli_query($conexion,"SELECT * FROM `productos_marykay` where inventario_producto != 0 ");
                                  while ($producto=mysqli_fetch_array($productos)) {
                                      ...
                                      echo '<option value="'.$id_producto.'" id="'.$id_producto.'">'.$nombre_producto.' /  '.$precio_compra.' /  '.$codigo_producto.'</option>';
                                  }
                              ?>
                          </select>
                          <br><br><br>
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_mary.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
