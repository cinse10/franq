          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Cubrebocas</h3>
              </div>
            </div>
                                ...
                                <?php 
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                    echo "<tr>";
                                      ...
                                      if($reportes==2 ){                                     
                                        echo "<th><a href='acciones_cubrebocas.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                        </th>";
                                      }else{
                                        echo "<th></th>";
                                      }
