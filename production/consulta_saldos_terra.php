                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito !=0 ) {
                                  ...
                                  $sql = "SELECT * FROM (`tickets_terra` INNER JOIN socios_terra ON tickets_terra.id_cliente = socios_terra.id_socio) INNER JOIN transacciones_terra on tickets_terra.id_ticket = transacciones_terra.id_ticket INNER JOIN productos_terra on transacciones_terra.id_producto = productos_terra.id_producto where saldo !=0 and fecha_add > NOW() - INTERVAL 2 MONTH";
