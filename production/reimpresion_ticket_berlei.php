                          ...
                          <table id="tabla_tickets" class="table table-striped table-bordered bulk_action">
                            ...
                            <tbody>
                              <?php 
                                ...
                                $sql = "SELECT * FROM ((`tickets_berlei` INNER JOIN socios_berlei ON tickets_berlei.id_cliente = socios_berlei.id_socio) INNER JOIN empleados ON tickets_berlei.id_empledo=empleados.id_empleado) ORDER BY fecha_ticket DESC";
                                ...
                                while ($reg=mysqli_fetch_array($requi)) {
                                  echo "<tr>";
                                    ...
                                    echo "<th><button class='btn btn-default btn-sm' onclick='checaTicket(".$reg["id_ticket"].");'><i class='fa fa-print'></i></button> 
                                              <a  href='devolucion_berlei.php?id_ticket=".$reg["id_ticket"]."' class='btn btn-default btn-sm'><i class='fa fa-cut'></i></a>&nbsp";
                                    $fechita = Date("Y-m-d");
   ...
   function manda_eliminar(id_ticket){
    ...
    $.ajax({
      ...
      success: function(data){ 
        ...
        window.location="reimpresion_ticket_berlei.php";
