			            ...
			            <div class="row">
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  ...
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_producto.php">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input name="codigo_extra" value="<?php echo $codigo_extra; ?>" class="form-control col-md-7 col-xs-12" type="text">
				                        </div>
				                      </div>
				                      <div class="form-group">
				                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Código SAT</label>
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input name="codigo_extra" value="<?php echo $codigo_sat; ?>" class="form-control col-md-7 col-xs-12" type="text">
				                        </div>
				                      </div>
				                      <div class="form-group">
