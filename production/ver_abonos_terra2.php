  <?php 
	...
	if (isset($_GET['id_ticket'])) {
		...
		$sql = "SELECT * FROM `apartado_terra`  INNER JOIN empleados ON apartado_terra.id_empledo=empleados.id_empleado WHERE id_ticket=".$id_ticket;
					                        ...
					                        <div class="x_content">
					                      	    <table id="tabla_transc" align="center" class="table table-striped table-bordered bulk_action">
						                            ...
						                            <tbody>
						                              <?php 
						                                include("conexion.php");
						                                $sql2 = "SELECT * FROM `transac_apartado_terra` INNER JOIN productos_terra ON transac_apartado_terra.id_producto=productos_terra.id_producto WHERE id_ticket=".$id_ticket;

						                                $requi2 = mysqli_query($conexion,$sql2);
						                                while ($reg=mysqli_fetch_array($requi2)) {
						                                  echo "<tr>";
						                                    echo "<th>".$reg['id_producto']."</th>";
						                                    echo "<th>".$reg['modelo_producto'].'-'.$reg['talla_producto'].'-'.$reg['color_producto']."</th>";
					                      ...
					                      <div class="x_panel">
                                            ...
                                            <th>Abono</th>
						                            ...
						                            <tbody>
						                              <?php 
						                                include("conexion.php");
						                                $sql3 = "SELECT * FROM `abonos_terra` WHERE id_ticket=".$id_ticket;
