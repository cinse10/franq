          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de socios Berlei</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                include("conexion.php");
                                  ...
                                  $sql = "Select * from socios_berlei WHERE id_socio!=1 && id_socio!=2 && id_socio!=3";
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                    $id_socio = $reg['id_socio'];
                                      ...
                                      echo "<tr>";
                                        ...
                                        $sql2 = "Select * from compras_berlei where compras_berlei.id_socio = $id_socio";
                                        ...
                                        while ($reg2=mysqli_fetch_array($requi2)) {
                                          ...
                                          if ($reg2['tipo_desc']==2) 
                                            echo "<th>5% DE DESCUENTO</th>"; 
                                          if ($reg2['tipo_desc']==3) 
                                            echo "<th>10% DE DESCUENTO</th>"; 
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios_berlei.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
...
<script type="text/javascript">
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SociosVickyForm_'+fechita+'.xls';
