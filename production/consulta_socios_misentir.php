                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito != 1 && $iddelempleadito != 5) {
                                  $sql = "Select * from socios where socios.id_empleado = $iddelempleadito or socios.id_empleado = 1";
                                  ...
                                  $sql = "Select * from socios where socios.id_empleado = 2 or socios.id_empleado = 1";
                                  $requi = mysqli_query($conexion,$sql);
                                  while ($reg=mysqli_fetch_array($requi)) {
