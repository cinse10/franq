<?php 
	...
	if (isset($_POST['id_ticket'])) {
		...
		$sql = "SELECT * FROM ((`tickets_nice` INNER JOIN socios ON tickets_nice.id_cliente = socios.id_socio) INNER JOIN empleados ON tickets_nice.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
