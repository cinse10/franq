                          ...
                          <table id="tabla_tickets" class="table table-striped table-bordered bulk_action">
                            ...
                            <tbody>
                              <?php 
                                ...
                                $sql = "SELECT * FROM ((`tickets_vicky` INNER JOIN socios_vicky ON tickets_vicky.id_cliente = socios_vicky.id_socio) INNER JOIN empleados ON tickets_vicky.id_empledo=empleados.id_empleado) ORDER BY fecha_ticket DESC";
   ...
   function manda_eliminar(id_ticket){
    ...
    $.ajax({
      ...
      success: function(data){ 
        ...
        window.location="reimpresion_ticket_vicky.php";
