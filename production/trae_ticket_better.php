<?php 
	...
	if (isset($_POST['id_ticket'])) {
		...
		$sql = "SELECT * FROM ((`tickets_betterware` INNER JOIN socios_better ON tickets_betterware.id_cliente = socios_better.id_socio) INNER JOIN empleados ON tickets_betterware.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
