                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_nice order by nombre_producto ASC";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                        ...
                                        if($reportes==2){                                     
                                          echo "<th><a href='acciones.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                          </th>";
                                        }else{
                                          echo "<th></th>";
                                        }
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'productosNICE_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "productosNICE_"+fechita+".pdf"
