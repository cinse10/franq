...
if (isset($_GET['action']) && isset($_GET['id_socio'])) {
  ...
  $sql = "select * from socios_better where id_socio=".$id_socio;
  ...
  if ($_GET['action']=="elimina") {
    ...
    echo '<script language="javascript">';
      ...
      if(mysqli_query($conexion,"delete from socios_better where id_socio=".$id_socio)){
        echo 'alert("Socio eliminado con éxito.");';
      }else{
        echo 'alert("Ocurrió un error al intentar borrar los datos.");';
      }
      echo 'window.location="consulta_socios_better.php";}else{';
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-4"></div>
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_socio_better.php" autocomplete="off">
