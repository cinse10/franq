          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de socios Cklass</h3>
              </div>
            </div>
                                    ...
                                    $id_socio = $reg['id_socio'];
                                      ...
                                      echo "<tr>";
                                        ...
                                        if ($reg['id_empleado']==4) 
                                          echo "<th>Cklass</th>";
                                        $sql2 = "Select * from compras_cklass where compras_cklass.id_socio = $id_socio";
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios_cklass.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
