          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Reporte Fondos Distribuciones Betterware</h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Distribuidor:  <span class="required">*</span>
                      </label>
                       <select class="form control selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio" onchange="funsiona()">                
                          <?php 
                            ...
                            echo '<option value="todos">Distribuciones Betterware</option>';
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tipo_usuario">Tipo:  <span class="required">*</span>
                      </label>
                       <select class="form control selectpicker" data-show-subtext="true" data-live-search="true" name="tipo_usuario" id="tipo_usuario" onchange="funsiona()">                
...
<script type="text/javascript">
  function checa() {
   ...
   var fin = document.getElementById("fecha2").value
    ...
    $.ajax({
      type: "POST",
      url: "trae_reporte_fondo_distbw.php",
      data: {'fecha_inicio': inicio, 'fecha_fin': fin,'id_empleado':empleado,'tipo_usuario':tipo_usuario,'ticket':tik},  
  ...
  function funsiona(inicio,fin) {
    ...
    var usuario = document.getElementById("tipo_usuario"); //El <select>
    var valusua = usuario.value; //El valor seleccionado
    tipo_usuario=valusua;
    console.log("Fecha inicio: "+ inicio+" Fecha fin: "+fin);
     $.ajax({
      type: "POST",
      url: "trae_reporte_fondo_distbw.php",
      data: {'fecha_inicio': inicio, 'fecha_fin': fin,'id_empleado':empleado,'tipo_usuario':tipo_usuario},  
      success: function(data){        
        if (data==0) {
          $('#tabla_reporte').empty();
          $('#tabla_reporte').append('No hay información');
