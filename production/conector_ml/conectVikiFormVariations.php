...
while ($reg=mysqli_fetch_array($requi)) {
    $id_producto = $reg['id_producto'];
                ...
                $i_uno = "http://13.59.1.71/franq/production/intima/vicky".$uno."";
				$i_dos = "http://13.59.1.71/franq/production/intima/vicky".$dos."";
				$i_tres = "http://13.59.1.71/franq/production/intima/vicky".$tres.""; 
    ...
    $sql1 = "select * from productos_vicky WHERE modelo_vf=".$modelo."";
    $re = mysqli_query($conexion,$sql1);
        while($resp=mysqli_fetch_array($re)){
            if($resp['modelo_vf']>1){
                $name = $resp['nombre'];
                $colo = $resp['color_vf'];
                
                print_r($resp['id_producto'].'</br>');
            }
        }
    ...
    switch ($tipo_producto) {
        case 16628:
            ...
            $precio_final = ceil((($precio_producto+ $pago_envio) * 1.19));
            $post = array(
