        ...
        $id_producto = $_GET['id_producto'];
            ...
            while ($reg=mysqli_fetch_array($requi)) {
               ...
               // $precio_publico = 	$precio_publico * 1.05;
                ...
                $i_uno = "http://13.59.1.71/bikenet.com.mx/bikes/".$uno."";
				$i_dos = "http://13.59.1.71/bikenet.com.mx/bikes/".$dos."";
				$i_tres = "http://13.59.1.71/bikenet.com.mx/bikes/".$tres."";     
        ...
        if ($tipo_bike==0) {
			...
			switch ($tipo_accesorio) {
        		...
        		case 2:
        			...
        			break;
        		case 3:
        			//Accesorios cATEGORIA: MLM12354
        			$categoria = "MLM12354";
		        	$envio = 160;
		        	$porcent = $precio_publico * 26 /100;
        			$precio_final = ceil($precio_publico + $porcent + $pago_envio +50);
					$put = array(
						   "title" => $nombre_producto,
						   "category_id" => $categoria, //Bicicleta-Triciclo MLM38486-Scooter MLM74484-Accesorios pa bicicletas (chacar tipos en ml)
						   "price" => $precio_final,
        		...
        		case 5:
		        	...
		        	$envio = 70;
					//$pago_envio = $envio-($envio*$desc_envio);
		        	$porcent = $precio_publico * 27 /100;
        			$precio_final = ceil($precio_publico + $porcent + $envio+30);
					$put = array(
						   "title" => $nombre_producto,
						   "category_id" => $categoria, //Bicicleta-Triciclo MLM38486-Scooter MLM74484-Accesorios pa bicicletas (chacar tipos en ml)
						   "price" => $precio_final,
...
/*
		...
		*/
				...
				echo '<script language="javascript">';
					echo 'alert("Actualizado exitoso Mercado Libre");';
					echo 'window.location="../acciones_bike.php?action=edita&id_producto='.$id_producto.'";';
				echo '</script>';
 ?>
