<?php 
    ...
    switch ($tipo_producto) {
        case 19405:
            ...
            $porcent = $precio_producto *22 /100;
        ...
        case 19410:
         ...
         $envio = 185;
         $pago_envio = $envio-($envio*$desc_envio);
         $porcent = $precio_producto *21 /100;
         $precio_final = ceil(($precio_producto + $pago_envio + $porcent));
         $post = array(
             "title" => $nombre_producto,
             "category_id" => $categoria,
       ...
       case 19408:
        ...
        $envio = 165;
        $pago_envio = $envio-($envio*$desc_envio);
        $porcent = $precio_producto * 23 /100;
        $precio_final = ceil(($precio_producto+ $pago_envio + $porcent)+45);
        $post = array(
            "title" => $nombre_producto,
            "category_id" => $categoria,
            "price" => $precio_final,
...
/*
 ...
 echo '<script language="javascript">';
                    echo 'alert("Actulizado con éxito a Mercado Libre");';
                    echo 'window.location="../plus_pintima.php?id_producto='.$id_producto.'";';
                echo '</script>';
