          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta Devoluciones Cklass</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito !=0 ) {
                                  ...
                                  $sql = "SELECT * FROM (`devoluciones_cklass` INNER JOIN socios_cklass ON devoluciones_cklass.id_cliente = socios_cklass.id_socio) INNER JOIN transacciones_cklass_devoluciones on devoluciones_cklass.id_ticket = transacciones_cklass_devoluciones.id_ticket INNER JOIN productos_cklass on transacciones_cklass_devoluciones.id_producto = productos_cklass.id_producto
                                  ";
