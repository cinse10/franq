          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Cklass</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_cklass";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                        ...
                                        echo "<th>$ ".$reg['precio_asociado']."</th>";
                                        echo "<th>$ ".$reg['precio_contado']."</th>";
                                        echo "<th>$ ".$reg['precio_oferta']."</th>";
                                       // echo "<th>$ ".$reg['precio_credito']."</th>";
                                        ...
                                        if($reportes==2){                                     
                                          echo "<th><a href='acciones_cklass.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                          </th>";
                                        }else{
                                          echo "<th> <a href='plus_cklass.php?id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-globe'></i></a></th>";
                                        }
                                      echo "</tr>";
                                    }
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosCklass_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosCklass_"+fechita+".pdf"
