<?php 
	...
	if (isset($_POST['fecha_inicio'])&&isset($_POST['fecha_fin'])) {
		...
		if ($_POST['id_empleado']==0) {
			$sql = "select * from tickets_dankriz INNER JOIN empleados ON tickets_dankriz.id_empledo=empleados.id_empleado INNER JOIN socios_dankriz ON tickets_dankriz.id_cliente=socios_dankriz.id_socio INNER JOIN transacciones_dankriz ON tickets_dankriz.id_ticket=transacciones_dankriz.id_ticket INNER JOIN productos_dankriz ON transacciones_dankriz.id_producto = productos_dankriz.id_producto where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'";	
		}else{
			$sql = "select * from tickets_dankriz INNER JOIN empleados ON tickets_dankriz.id_empledo=empleados.id_empleado INNER JOIN socios_dankriz ON tickets_dankriz.id_cliente=socios_dankriz.id_socio INNER JOIN transacciones_dankriz ON tickets_dankriz.id_ticket=transacciones_dankriz.id_ticket INNER JOIN productos_dankriz ON transacciones_dankriz.id_producto = productos_dankriz.id_producto where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND empleados.id_empleado=".$_POST['id_empleado'];	
		}
		...
		if (isset($_POST['ticket'])) {
				...
				$direccion="";
				$leyenda_inferior="";
				$confi = "select * from configuracion where id_configuracion = 12";
