          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Importados</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                include("conexion.php");
                                  ...
                                  $sql = "select * from productos_importados where inventario_producto = '0'";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinstockDankriz_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinStockDankriz_"+fechita+".pdf"
