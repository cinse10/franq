				...
				if ($row['inventario_producto']>0) {
					if ($row['inventario_tmp_producto']>0) {		
						if ($_POST['id_cliente']==1 || $_POST['id_cliente']==2) {
							...
							if ($row['libro_producto']=='IMPORTADOS') {
								if ($_POST['id_cliente']==30) {
									$precio_desc = round($row['precio_clave']-($row['precio_clave']*0.45),1,PHP_ROUND_HALF_UP);
									echo "<tr>
										<td>".$row['id_producto']."</td>
										<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
								...
								}else if ($_POST['id_cliente']==246) {
									$precio_desc = round($row['precio_oferta']-($row['precio_oferta']*0.45),1,PHP_ROUND_HALF_UP);
									echo "<tr>
										<td>".$row['id_producto']."</td>
										<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
								...
								}else if ($_POST['id_cliente']==213) {
									$precio_desc = round($row['precio_clave']-($row['precio_clave']*0.34),1,PHP_ROUND_HALF_UP);
									echo "<tr>
										<td>".$row['id_producto']."</td>
										<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
										<td class='precio'>$ ".$row['precio_clave']."</td>
							...
							}elseif ($row['libro_producto']=='VERANO') {
								if ($_POST['id_cliente']==30) {
									$precio_desc = round($row['precio_clave']-($row['precio_clave']*0.40),1,PHP_ROUND_HALF_UP);
									echo "<tr>
										<td>".$row['id_producto']."</td>
										<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
										<td class='precio'>$ ".$row['precio_clave']."</td>
								...
								if ($row['lista_producto']=='1') {
									if ($_POST['id_cliente']==30) {
										$precio_desc = round($row['precio_clave']-($row['precio_clave']*0.22),1,PHP_ROUND_HALF_UP);
											echo "<tr>
												<td>".$row['id_producto']."</td>
												<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
												<td class='precio'>$ ".$row['precio_clave']."</td>
										...
										$precio_desc = round($row['precio_oferta']-($row['precio_oferta']*0.22),1,PHP_ROUND_HALF_UP);
											echo "<tr>
												<td>".$row['id_producto']."</td>
												<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
												<td class='precio'>$ ".$row['precio_oferta']."</td>
									...
									if ($_POST['id_cliente']==30) {
										...
										//EMPLEADO OFERTA
										$precio_desc = round($row['precio_oferta']-($row['precio_oferta']*0.34),1,PHP_ROUND_HALF_UP);
											echo "<tr>
												<td>".$row['id_producto']."</td>
												<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
												<td class='precio'>$ ".$row['precio_oferta']."</td>
									...
									if ($_POST['id_cliente']==30) {
										...
										$precio_desc = round($row['precio_clave']-($row['precio_clave']*0.24),1,PHP_ROUND_HALF_UP);
											echo "<tr>
												<td>".$row['id_producto']."</td>
												<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
												<td class='precio'>$ ".$row['precio_']."</td>
												<td class='precio'>$ ".$precio_desc."</td>
												<td><span class='glyphicon glyphicon-trash borrar'/></td>
											 </tr>";
									}else{
										//$precio_desc = round($row['precio_clave']-($row['precio_clave']*0.08),1,PHP_ROUND_HALF_UP);
										$precio_desc = round($row ['precio_clave']);
										echo "<tr>
												<td>".$row['id_producto']."</td>
												<td>".$row['modelo_producto'].'-'.$row['talla_producto'].'-'.$row['color_producto']."</td>
												<td class='precio'>$ ".$row['precio_pagos']."</td>
