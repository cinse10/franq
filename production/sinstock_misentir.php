          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Mi sentir</h3>
              </div>
            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="x_panel">
                        <div class="x_content">
                          ...
                          <table id="tablin" class="table table-striped table-bordered bulk_action dataTable js-exportable">
                            <thead>
                              <tr>
                                <th>ID</th> 
                            ...
                            <tbody>
                              <?php 
                                include("conexion.php");
                                  ...
                                  $sql = "select * from productos_misentir where inventario_producto = '0' order by nombre_producto ASC";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinstockMiSentir_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinstockMiSentir_"+fechita+".pdf"
