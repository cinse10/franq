          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta Devoluciones Terra</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito !=0 ) {
                                  ...
                                  $sql = "SELECT * FROM (`devoluciones_terra` INNER JOIN socios_terra ON devoluciones_terra.id_cliente = socios_terra.id_socio) INNER JOIN transacciones_terra_devoluciones on devoluciones_terra.id_ticket = transacciones_terra_devoluciones.id_ticket INNER JOIN productos_terra on transacciones_terra_devoluciones.id_producto = productos_terra.id_producto
                                  ";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'Saldos Terra_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "Saldos Terra_"+fechita+".pdf"
