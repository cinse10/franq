<?php 
	...
	if (isset($_POST['fecha_inicio'])&&isset($_POST['fecha_fin'])) {
		...
		if ($_POST['id_empleado']==0 && $_POST['fpago']==0) {
		...
		}elseif($_POST['id_empleado']==0 && $_POST['fpago']==1){
			$sql = "select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_misentir INNER JOIN empleados ON tickets_misentir.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_misentir.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_misentir.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets INNER JOIN empleados ON tickets.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets.id_cliente=socios.id_socio INNER JOIN marcas ON tickets.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_intima INNER JOIN empleados ON tickets_intima.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_intima.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_intima.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_intima_bf INNER JOIN empleados ON tickets_intima_bf.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_intima_bf.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_intima_bf.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_vicky INNER JOIN empleados ON tickets_vicky.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_vicky.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_vicky.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_desc_vicky INNER JOIN empleados ON tickets_desc_vicky.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_desc_vicky.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_desc_vicky.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_terra INNER JOIN empleados ON tickets_terra.id_empledo=empleados.id_empleado INNER JOIN socios_terra ON tickets_terra.id_cliente=socios_terra.id_socio INNER JOIN marcas ON tickets_terra.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_terra_desc INNER JOIN empleados ON tickets_terra_desc.id_empledo=empleados.id_empleado INNER JOIN socios_terra ON tickets_terra_desc.id_cliente=socios_terra.id_socio INNER JOIN marcas ON tickets_terra_desc.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cklass INNER JOIN empleados ON tickets_cklass.id_empledo=empleados.id_empleado INNER JOIN socios_cklass ON tickets_cklass.id_cliente=socios_cklass.id_socio INNER JOIN marcas ON tickets_cklass.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO'UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cklass_promo INNER JOIN empleados ON tickets_cklass_promo.id_empledo=empleados.id_empleado INNER JOIN socios_cklass ON tickets_cklass_promo.id_cliente=socios_cklass.id_socio INNER JOIN marcas ON tickets_cklass_promo.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cklass_op INNER JOIN empleados ON tickets_cklass_op.id_empledo=empleados.id_empleado INNER JOIN socios_cklass ON tickets_cklass_op.id_cliente=socios_cklass.id_socio INNER JOIN marcas ON tickets_cklass_op.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_nice INNER JOIN empleados ON tickets_nice.id_empledo=empleados.id_empleado INNER JOIN socios_nice ON tickets_nice.id_cliente=socios_nice.id_socio INNER JOIN marcas ON tickets_nice.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_marykay INNER JOIN empleados ON tickets_marykay.id_empledo=empleados.id_empleado INNER JOIN socios_mk ON tickets_marykay.id_cliente=socios_mk.id_socio INNER JOIN marcas ON tickets_marykay.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_betterware INNER JOIN empleados ON tickets_betterware.id_empledo=empleados.id_empleado INNER JOIN socios_better ON tickets_betterware.id_cliente=socios_better.id_socio INNER JOIN marcas ON tickets_betterware.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago = 'EFECTIVO' UNION ALL select apartado_misentir.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca from apartado_misentir INNER JOIN abonos_misentir ON apartado_misentir.id_ticket = abonos_misentir.id_ticket INNER JOIN empleados ON apartado_misentir.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_misentir.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago = 'EFECTIVO' UNION ALL SELECT apartado_bike.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_bike INNER JOIN abonos_bike ON apartado_bike.id_ticket = abonos_bike.id_ticket INNER JOIN empleados ON apartado_bike.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_bike.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago = 'EFECTIVO' UNION ALL SELECT apartado_intima.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_intima INNER JOIN abonos_intima ON apartado_intima.id_ticket = abonos_intima.id_ticket INNER JOIN empleados ON apartado_intima.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_intima.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago = 'EFECTIVO' UNION ALL SELECT apartado_vicky.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_vicky INNER JOIN abonos_vicky ON apartado_vicky.id_ticket = abonos_vicky.id_ticket INNER JOIN empleados ON apartado_vicky.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_vicky.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago = 'EFECTIVO' UNION ALL SELECT apartado_terra.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_terra INNER JOIN abonos_terra ON apartado_terra.id_ticket = abonos_terra.id_ticket INNER JOIN empleados ON apartado_terra.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_terra.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago = 'EFECTIVO' UNION ALL SELECT apartado_cklass.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_cklass INNER JOIN abonos_cklass ON apartado_cklass.id_ticket = abonos_cklass.id_ticket INNER JOIN empleados ON apartado_cklass.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_cklass.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago = 'EFECTIVO' UNION ALL SELECT apartado_nice.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_nice INNER JOIN abonos_nice ON apartado_nice.id_ticket = abonos_nice.id_ticket INNER JOIN empleados ON apartado_nice.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_nice.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_dankriz INNER JOIN empleados ON tickets_dankriz.id_empledo=empleados.id_empleado INNER JOIN socios_dankriz ON tickets_dankriz.id_cliente=socios_dankriz.id_socio INNER JOIN marcas ON tickets_dankriz.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio != 64
			AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_chiqui INNER JOIN empleados ON tickets_chiqui.id_empledo=empleados.id_empleado INNER JOIN socios_chiqui ON tickets_chiqui.id_cliente=socios_chiqui.id_socio INNER JOIN marcas ON tickets_chiqui.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago = 'EFECTIVO'  UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cubrebocas INNER JOIN empleados ON tickets_cubrebocas.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_cubrebocas.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_cubrebocas.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_importados INNER JOIN empleados ON tickets_importados.id_empledo=empleados.id_empleado INNER JOIN socios_dankriz ON tickets_importados.id_cliente=socios_dankriz.id_socio INNER JOIN marcas ON tickets_importados.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago = 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_berlei INNER JOIN empleados ON tickets_berlei.id_empledo=empleados.id_empleado INNER JOIN socios_berlei ON tickets_berlei.id_cliente=socios_berlei.id_socio INNER JOIN marcas ON tickets_berlei.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'";
		}elseif($_POST['id_empleado']==0 && $_POST['fpago']==2){
			$sql = "select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_misentir INNER JOIN empleados ON tickets_misentir.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_misentir.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_misentir.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets INNER JOIN empleados ON tickets.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets.id_cliente=socios.id_socio INNER JOIN marcas ON tickets.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_intima INNER JOIN empleados ON tickets_intima.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_intima.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_intima.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago = !'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_intima_bf INNER JOIN empleados ON tickets_intima_bf.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_intima_bf.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_intima_bf.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio!=137 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_vicky INNER JOIN empleados ON tickets_vicky.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_vicky.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_vicky.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_desc_vicky INNER JOIN empleados ON tickets_desc_vicky.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_desc_vicky.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_desc_vicky.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_terra INNER JOIN empleados ON tickets_terra.id_empledo=empleados.id_empleado INNER JOIN socios_terra ON tickets_terra.id_cliente=socios_terra.id_socio INNER JOIN marcas ON tickets_terra.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_terra_desc INNER JOIN empleados ON tickets_terra_desc.id_empledo=empleados.id_empleado INNER JOIN socios_terra ON tickets_terra_desc.id_cliente=socios_terra.id_socio INNER JOIN marcas ON tickets_terra_desc.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cklass INNER JOIN empleados ON tickets_cklass.id_empledo=empleados.id_empleado INNER JOIN socios_cklass ON tickets_cklass.id_cliente=socios_cklass.id_socio INNER JOIN marcas ON tickets_cklass.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO'UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cklass_promo INNER JOIN empleados ON tickets_cklass_promo.id_empledo=empleados.id_empleado INNER JOIN socios_cklass ON tickets_cklass_promo.id_cliente=socios_cklass.id_socio INNER JOIN marcas ON tickets_cklass_promo.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cklass_op INNER JOIN empleados ON tickets_cklass_op.id_empledo=empleados.id_empleado INNER JOIN socios_cklass ON tickets_cklass_op.id_cliente=socios_cklass.id_socio INNER JOIN marcas ON tickets_cklass_op.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_nice INNER JOIN empleados ON tickets_nice.id_empledo=empleados.id_empleado INNER JOIN socios_nice ON tickets_nice.id_cliente=socios_nice.id_socio INNER JOIN marcas ON tickets_nice.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_marykay INNER JOIN empleados ON tickets_marykay.id_empledo=empleados.id_empleado INNER JOIN socios_mk ON tickets_marykay.id_cliente=socios_mk.id_socio INNER JOIN marcas ON tickets_marykay.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_betterware INNER JOIN empleados ON tickets_betterware.id_empledo=empleados.id_empleado INNER JOIN socios_better ON tickets_betterware.id_cliente=socios_better.id_socio INNER JOIN marcas ON tickets_betterware.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'  &&  id_socio!=2 AND forma_pago != 'EFECTIVO' UNION ALL select apartado_misentir.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca from apartado_misentir INNER JOIN abonos_misentir ON apartado_misentir.id_ticket = abonos_misentir.id_ticket INNER JOIN empleados ON apartado_misentir.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_misentir.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago != 'EFECTIVO' UNION ALL SELECT apartado_bike.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_bike INNER JOIN abonos_bike ON apartado_bike.id_ticket = abonos_bike.id_ticket INNER JOIN empleados ON apartado_bike.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_bike.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago != 'EFECTIVO' UNION ALL SELECT apartado_intima.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_intima INNER JOIN abonos_intima ON apartado_intima.id_ticket = abonos_intima.id_ticket INNER JOIN empleados ON apartado_intima.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_intima.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago != 'EFECTIVO' UNION ALL SELECT apartado_vicky.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_vicky INNER JOIN abonos_vicky ON apartado_vicky.id_ticket = abonos_vicky.id_ticket INNER JOIN empleados ON apartado_vicky.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_vicky.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago != 'EFECTIVO' UNION ALL SELECT apartado_terra.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_terra INNER JOIN abonos_terra ON apartado_terra.id_ticket = abonos_terra.id_ticket INNER JOIN empleados ON apartado_terra.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_terra.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago != 'EFECTIVO' UNION ALL SELECT apartado_cklass.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_cklass INNER JOIN abonos_cklass ON apartado_cklass.id_ticket = abonos_cklass.id_ticket INNER JOIN empleados ON apartado_cklass.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_cklass.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago != 'EFECTIVO' UNION ALL SELECT apartado_nice.id_ticket, abono, forma_pago, fecha_abono, nombre_empleado, ap_pat_empleado, nombre_cliente, nombre_marca FROM apartado_nice INNER JOIN abonos_nice ON apartado_nice.id_ticket = abonos_nice.id_ticket INNER JOIN empleados ON apartado_nice.id_empledo = empleados.id_empleado INNER JOIN marcas ON apartado_nice.id_marca = marcas.id_marca where fecha_abono between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'
			 AND forma_pago !='EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_dankriz INNER JOIN empleados ON tickets_dankriz.id_empledo=empleados.id_empleado INNER JOIN socios_dankriz ON tickets_dankriz.id_cliente=socios_dankriz.id_socio INNER JOIN marcas ON tickets_dankriz.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' && id_socio != 64
			AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_chiqui INNER JOIN empleados ON tickets_chiqui.id_empledo=empleados.id_empleado INNER JOIN socios_chiqui ON tickets_chiqui.id_cliente=socios_chiqui.id_socio INNER JOIN marcas ON tickets_chiqui.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago != 'EFECTIVO'  UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_cubrebocas INNER JOIN empleados ON tickets_cubrebocas.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_cubrebocas.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_cubrebocas.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_importados INNER JOIN empleados ON tickets_importados.id_empledo=empleados.id_empleado INNER JOIN socios_dankriz ON tickets_importados.id_cliente=socios_dankriz.id_socio INNER JOIN marcas ON tickets_importados.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago != 'EFECTIVO' UNION ALL select id_ticket, total_ticket, forma_pago, fecha_ticket, nombre_empleado, ap_pat_empleado, nombre_socio, nombre_marca from tickets_berlei INNER JOIN empleados ON tickets_berlei.id_empledo=empleados.id_empleado INNER JOIN socios_berlei ON tickets_berlei.id_cliente=socios_berlei.id_socio INNER JOIN marcas ON tickets_berlei.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND forma_pago != 'EFECTIVO'";
		}
		else{ 
			...
			while ($reporte = mysqli_fetch_array($resp)) {
				...
				if (!isset($_POST['ticket'])) {
					echo "<tr>";
						...
						echo "</th>";
                        echo "<th>";
						$idym = $id_ticket -> $marca;
						echo "<input type='checkbox' class='fac' id='checkb' name='check[]' value= '".$id_ticket.";' onclick='valor()'>";
						//onclick='valor(".$id_ticket.")
						echo "</th>";
					echo "</tr>";					
				}
			}
			if (!isset($_POST['ticket'])) {
				echo "<tr><th></th><th></th><th></th><th></th><th></th><th></th><th style='font-weight: bold; font-size:20px;'>Total</th><th style='font-weight: bold; font-size:20px;'>$ ".number_format($suma,2)."</th></tr>";
				echo "<tr><th></th><th></th><th></th><th></th><th></th><th></th><th style='font-weight: bold; font-size:20px;'>Total Efectivo</th><th style='font-weight: bold; font-size:20px;'>$ ".number_format($sumaEfe,2)."</th></tr>";
				echo "<tr><th></th><th></th><th></th><th></th><th></th><th></th><th style='font-weight: bold; font-size:20px;'>Total Tarjeta</th><th style='font-weight: bold; font-size:20px;'>$ ".number_format($sumaTDD,2)."</th></tr>";
				echo '</tbody></table>';
			}
		}
		if (isset($_POST['ticket'])) {
			...
			echo "<img src='".$logo."' width='120' height='100' style='margin-top: -30;'>";
			//echo "<br><br>";
			...
			echo "<br><br>";
				...
				echo "<h4>Reporte de pagos Facturados</h4><br>";	
				echo 'Del: '.$fecha_ini;
				echo "<br>";
				echo ' a: '.$fecha_fin;
				echo "<br><hr>";
			  ...
			  echo "</table>";
		        ...
		        echo '<tr>
		        	<th>Efectivo</th>
		        	<th class="precio centrado">id ticket '.$id_ticket.'</th>
		        	</tr>
		        	<tr>
		        	<th>Tarjeta</th>
		        	<th class="precio centrado">$ '.$nombre.'</th>
		        	</tr>
		        	<tr>
		        	<th>Tarjeta</th>
...
<script src="sweetalert.min.js"></script>
 ...
 function valor() {	
  ...
  $("input:checkbox[name=check]:checked").each(function () {
	arr.push($(this).val().slice(0,-1));
		console.log(arr)

		/*swal("Venta Facturada", {
			buttons: false,
			icon: "success",
			timer: 2000,
		});*/
	...
	let ast = JSON.stringify(arr)
	$.ajax({
          type: "POST",
          url: "obtiene_ticket_facturado.php",
          data: {arr:ast,},  
