          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta Saldos Chiqui Mundo</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito !=0 ) {
                                  ...
                                  $sql = "SELECT * FROM (`tickets_chiqui_mundo` INNER JOIN socios_chiqui_mundo ON tickets_chiqui_mundo.id_cliente = socios_chiqui_mundo.id_socio) INNER JOIN transacciones_chiqui_mundo on tickets_chiqui_mundo.id_ticket = transacciones_chiqui_mundo.id_ticket INNER JOIN productos_chiqui_mundo on transacciones_chiqui_mundo.id_producto = productos_chiqui_mundo.id_producto where saldo !=0 and fecha_add > NOW() - INTERVAL 2 MONTH";
