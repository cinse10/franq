<?php 
	...
	$sql = "SELECT * FROM ((`tickets_chiqui` INNER JOIN socios_chiqui ON tickets_chiqui.id_cliente = socios_chiqui.id_socio) INNER JOIN empleados ON tickets_chiqui.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Devolución de Productos Chiqui Mundo</h3>
      </div>
    </div>
                    ...
                    <tbody>
                      <?php 
                        ...
                        if (isset($_GET['id_ticket'])) {
                                ...
                                echo "<th>".$producto['codigo_barras']."</th>";
...
function eliminar(id_transaccion) {
   ...
   function manda_eliminar(id_transaccion){
    ...
    $.ajax({
      ...
      data: {'id_ticket': id_ticket, 'id_transaccion': id_transaccion, 'marca' : 12},  
