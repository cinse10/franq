          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de socios Chuiqui Mundo</h3>
              </div>
            </div>
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                    $id_socio = $reg['id_socio'];
                                      ...
                                      echo "<tr>";
                                        ...
                                        if ($reg['id_empleado']==7) 
                                          echo "<th>Chiqui Mundo</th>";
                                        else
                                          echo "<th>Chiqui Mundo</th>";

                                        $sql2 = "Select * from compras_chiqui where compras_chiqui.id_socio = $id_socio";
                                        ...
                                        while ($reg2=mysqli_fetch_array($requi2)) {
                                          ...
                                          if ($reg2['tipo_desc']==2) 
                                            echo "<th>3% BRONCE</th>"; 
                                          if ($reg2['tipo_desc']==3) 
                                            echo "<th>6% MERCURIO</th>"; 
                                          if ($reg2['tipo_desc']==4) 
                                            echo "<th>12% PLATA</th>"; 
                                          if ($reg2['tipo_desc']==5) 
                                            echo "<th>18% TITANIUM</th>";
                                          if ($reg2['tipo_desc']==6) 
                                            echo "<th>20% ORO</th>";  
                                          if ($reg2['tipo_desc']==7) 
                                            echo "<th>22% PLATINO</th>";
                                          if ($reg2['tipo_desc']==8) 
                                            echo "<th>25% DIAMANTE</th>"; 
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios_chiqui.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
...
<script type="text/javascript">
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SociosChiqui_Mundo_'+fechita+'.xls';
