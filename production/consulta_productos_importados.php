          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Importados</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_importados";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                       ...
                                       $pre_clave =  $reg['precio_afiliado'] ;
                                       $porcent = $pre_clave *20 /100;
                                       $pre_emp = $pre_clave - $porcent ;
                                        echo "<th>$ ".$pre_emp."</th>";
                                        ...
                                        if($reportes==2){                                     
                                          echo "<th><a href='acciones_importados.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                          </th>";
                                        }else{
                                          echo "<th></th>";
                                        }
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosDankriz_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosDankriz_"+fechita+".pdf"
