          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Bike Store</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "SELECT * FROM `productos_bike`  where inventario_producto = '0' order by nombre_producto ASC";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinStockBikeStore_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            doc.text("Bike Store",X+300,Y-50);
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinStockBikeStore"+fechita+".pdf"
