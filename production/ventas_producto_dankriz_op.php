                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar()">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_dankriz` WHERE inventario_producto!=0");
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "SELECT * FROM `socios_dankriz`  WHERE id_socio!=71";
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_dankriz_op.php",
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_dankriz_op.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
