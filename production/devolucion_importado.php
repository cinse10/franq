<?php 
  ...
  $sql = "SELECT * FROM ((`tickets_importados` INNER JOIN socios_dankriz ON tickets_importados.id_cliente = socios_dankriz.id_socio) INNER JOIN empleados ON tickets_importados.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Devolución de Productos Dankriz</h3>
      </div>
    </div>
...
function eliminar(id_transaccion) {
  ...
  var id_ticket = document.getElementById("id_ticket").value;
    ...
    $.ajax({
      ...
      data: {'id_ticket': id_ticket, 'id_transaccion': id_transaccion, 'marca' : 13},  
