          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Chiqui Mundo</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_chiqui";
                                    $requi = mysqli_query($conexion,$sql);
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                        echo "<th>".$reg['id_producto']."</th>";
                                        echo "<th>".$reg['nombre_producto']."</th>";
                                        echo "<th>".$reg['codigo_producto']."</th>";
                                        echo "<th>".$reg['descripcion']."</th>";
                                        echo "<th>$ ".$reg['precio_empleado']."</th>";
                                        echo "<th>$ ".$reg['precio_afiliado']."</th>";
                                        echo "<th>$ ".$reg['precio_publico']."</th>";
                                        //echo "<th>".$reg['combo_id']."</th>";
                                        echo "<th>".$reg['inventario_producto']."</th>";
                                        echo "<th>".$reg['codigo_barras']."</th>";
                                        //echo "<th>".$reg['catalogo_producto']."</th>";
                                        ...
                                        if($reportes==2){                                     
                                          ...
                                          echo "<th><a href='plus_chiqui.php?id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-globe'></i></a></th>";
                                        }
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosChiquiMundo_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosChiqui_"+fechita+".pdf"
