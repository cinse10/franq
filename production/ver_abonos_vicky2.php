					                        ...
					                        <div class="x_content">
					                      	    <table id="tabla_transc" align="center" class="table table-striped table-bordered bulk_action">
						                            ...
						                            <tbody>
						                              <?php 
						                                include("conexion.php");
						                                $sql2 = "SELECT * FROM `transac_apartado_vicky` INNER JOIN productos_vicky ON transac_apartado_vicky.id_producto=productos_vicky.id_producto WHERE id_ticket=".$id_ticket;

						                                $requi2 = mysqli_query($conexion,$sql2);
						                                while ($reg=mysqli_fetch_array($requi2)) {
						                                  echo "<tr>";
						                                    echo "<th>".$reg['id_producto']."</th>";
						                                    echo "<th>".$reg['descripcion_vf'].'-'.$reg['talla_vf'].'-'.$reg['color_vf']."</th>";
					                      ...
					                      <div class="x_panel">
                                            ...
                                            <th>Abono</th>
						                            ...
						                            <tbody>
						                              <?php 
						                                include("conexion.php");
						                                $sql3 = "SELECT * FROM `abonos_vicky` WHERE id_ticket=".$id_ticket;
