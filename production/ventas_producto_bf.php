          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ventas Mayoristas Intima</h3>
              </div>
            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio" >
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "Select * from socios WHERE id_socio!=408 AND id_socio!=410 AND id_socio!=411";
...
<script type="text/javascript">
  ...
  function efectivoTarjeta() {
     ...
     alertify.confirm('Pago', '¿Método de pago?', 
      function(){ 
        ...
        muestra_total(total,porcentaje);
      }
      , function(){ 
        porcentaje = (porcentaje).toFixed();
        var total = suma-porcentaje;
        muestra_tarjeta(total,porcentaje);
    ...
    myWindow.document.write("<div class='ticket centrado'>");
      ...
      myWindow.document.write("<table><thead><tr><th class='producto'>PRODUCTO</th><th class='precio'>PRECIO</th></tr></thead>");
        myWindow.document.write("<tbody>");
          ...
          myWindow.document.write("<tr><td class='total'>Descuento: </td><td class='precio centrado total'>$ "+porcentaje+"</td></tr>");
          myWindow.document.write("<tr><td class='total'>Total con Descuento: </td><td class='precio centrado total'>$ "+tfinal+"</td></tr>");
        myWindow.document.write("</tbody>");
  ...
  // }
   ...
   function muestra_total(total,desc){
    var pagado=0;
    alertify.prompt("Ventana de cobro!","Total a pagar: $ "+total+" Descuento: $ "+desc+"\nIngresa pago recibido: ", "",
            function(evt, value ){
              pagado=value;
