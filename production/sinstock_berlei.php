          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Berlei</h3>
              </div>
            </div>
                            ...
                            <table id="tablin" class="table table-striped table-bordered bulk_action">
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  $sql = "select * from productos_berlei where inventario_producto = '0' ";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinStockBerlei_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinStockBerlei_"+fechita+".pdf"
