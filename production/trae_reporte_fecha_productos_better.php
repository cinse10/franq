<?php 
	...
	if (isset($_POST['fecha_inicio'])&&isset($_POST['fecha_fin'])) {
		...
		if ($_POST['id_empleado']==0) {
			$sql = "select * from tickets_betterware INNER JOIN empleados ON tickets_betterware.id_empledo=empleados.id_empleado INNER JOIN socios_better ON tickets_betterware.id_cliente=socios_better.id_socio INNER JOIN transacciones_betterware ON tickets_betterware.id_ticket=transacciones_betterware.id_ticket INNER JOIN productos_betterware ON transacciones_betterware.id_producto = productos_betterware.id_producto where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'";	
		}else{
			$sql = "select * from tickets_betterware INNER JOIN empleados ON tickets_betterware.id_empledo=empleados.id_empleado INNER JOIN socios_better ON tickets_betterware.id_cliente=socios_better.id_socio INNER JOIN transacciones_betterware ON tickets_betterware.id_ticket=transacciones_betterware.id_ticket INNER JOIN productos_betterware ON transacciones_betterware.id_producto = productos_betterware.id_producto where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND empleados.id_empleado=".$_POST['id_empleado'];	
		}
