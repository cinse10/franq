 <?php 
  ...
  $kuerito =  "Select * from productos_chiqui";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_chiqui set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Devoluciones Chiqui Mundo</h3>
              </div>
            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_chiqui` WHERE inventario_producto!=0");
                                    while ($producto=mysqli_fetch_array($productos)) {
                                        ...
                                        echo '<option value= "'.$id_producto.'">'.$nombre_producto.' - '.$descripcion_producto.' /  '.$codigo_barras_producto.'</option>';
                                    }
                                ?>
                            </select>
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_chiqui_dev.php",
  ...
  function Genera_ticket(){
    $.ajax({
      type: "POST",
      url: "guarda_devoluciones_chiqui.php",
  ...
  function traeSaldo(){
    $.ajax({
        ...
        data: {'id_cliente': cliente, 'marca': 12},  
