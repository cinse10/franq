          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Mary Kay</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_marykay order by nombre_producto ASC";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                        ...
                                        echo "<th><a href='acciones_mary.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>
                                          </th>";
...
<script src="js/jspdf.plugin.autotable.js"></script>
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosMaryKay_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosMaryKay_"+fechita+".pdf"
