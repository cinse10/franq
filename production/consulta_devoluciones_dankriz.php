          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta Devoluciones Dankriz</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito !=0 ) {
                                  ...
                                  $sql = "SELECT * FROM (`devoluciones_dankriz` INNER JOIN socios_dankriz ON devoluciones_dankriz.id_cliente = socios_dankriz.id_socio) INNER JOIN transacciones_dankriz_devoluciones on devoluciones_dankriz.id_ticket = transacciones_dankriz_devoluciones.id_ticket INNER JOIN productos_dankriz on transacciones_dankriz_devoluciones.id_producto = productos_dankriz.id_producto
                                  ";
                                  ...
                                  $sql = "select * from productos_dankriz";
                                  $requi = mysqli_query($conexion,$sql);
                                  while ($reg=mysqli_fetch_array($requi)) {
                                    echo "<tr>";
                                      ...
                                      if($reportes==2){                                     
                                        echo "<th><a href='acciones_dankriz.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                        </th>";
                                      }else{
                                        echo "<th></th>";
                                      }
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "Devoluciones Dankriz_"+fechita+".pdf"
