<?php 
  ...
  $kuerito =  "Select * from productos_terra";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_terra set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Devoluciones Mundo Terra</h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12">                      
                        <div class="form-group" >
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();" >
                            <select class="selectpicker"  data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_terra`  ");
                      ...
                      <button style="float: right;" class="btn btn-primary" onclick="traeSaldo();">Devolver</button>
                      <div id="ajax"></div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "SELECT * FROM `socios_terra` WHERE id_socio!=67 AND id_socio!=36 AND id_socio!=4";
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_terra1.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
  ...
  function efectivoTarjeta() {
    var final = Math.round(suma-saldo);
     alertify.confirm()
     alertify.confirm('¿Deseas devolver este Producto?', 
    ...
    var pagado=0;
    alertify.prompt("Ventana!","Total a pagar: $ "+total+"\nIngresa el monto a pagar con Tarjeta: ", "",
            function(evt, value ){
              pagado=value;
  ...
  function Genera_ticketTDD(id_transaccion){
    ...
    $.ajax({
      type: "POST",
      url: "guarda_devoluciones_terra.php",
  ...
  function traeSaldo(){
    $.ajax({
        ...
        data: {'id_cliente': cliente, 'marca': 6},  
  ...
  function Suma(){  
    ...
    $('#tdtotal').text("$ "+(Math.ceil(suma)+Math.floor(suma))/2);
  }
  ...
  // }
   ...
   function muestra_total(total){
    var pagado=0;
    alertify.prompt("Ventana!","Total a Regresar: $ "+total+"\nIngresa pago recibido: ", "",
            function(evt, value ){
              pagado=value;
      ...
      if(Number.isInteger(pagado)){
        ...
        if(pagado<0){
          ...
          if(total>pagado){      
            ...
            alertify
              .alert("Se ha devuelto con exito!", function(){
              Genera_ticket();
              alertify.message('OK');
              });
          }
