          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Chiqui Mundo</h3>
              </div>
            </div>
                            ...
                            <tbody>
                              <?php 
                                include("conexion.php");
                                  ...
                                  $sql = "select * from productos_chiqui where inventario_producto = '0'";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinstockCklass_'+fechita+'.xls';
  ...
  function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinStockCklass_"+fechita+".pdf"
