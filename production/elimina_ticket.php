<?php 
	...
	if (isset($_POST['id_ticket'])) {
		...
		if ($marca ==2) {
			$sql = "UPDATE `tickets` SET `total_ticket`='0'  WHERE id_ticket=".$id_ticket;
			if(mysqli_query($conexion,$sql)){
				...
				$sql3 = "UPDATE `transacciones` SET `precio_venta`='0' WHERE id_ticket=".$id_ticket;
				mysqli_query($conexion,$sql3);
			}				
		}
		if ($marca ==3) {
			...
			if(mysqli_query($conexion,$sql)){
				...
				$sql3 = "UPDATE `transacciones_intima` SET `precio_venta`='0' WHERE id_ticket=".$id_ticket;
				mysqli_query($conexion,$sql3);
			}				
		}
		if ($marca ==4) {
