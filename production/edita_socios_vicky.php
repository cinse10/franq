...
if (isset($_GET['action']) && isset($_GET['id_socio'])) {
  ...
  $sql = "select * from socios_vicky where id_socio=".$id_socio;
  ...
  if(mysqli_num_rows($consulta)>0){
    ...
    $codigo_lealtad = $socio['codigo'];    

  }
  $sql2 = "select * from compras_vicky where id_socio=".$id_socio;
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-4"></div>
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_socio_vicky.php" autocomplete="off">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="ap_pat_socio" required="required"  class="form-control col-md-7 col-xs-12" type="text" name="middle-name" placeholder="Apellido paterno" value="<?php echo $ap_pat_socio; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Apellido Materno <span class="required">*</span></label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="ap_mat_socio" required="required"  class="form-control col-md-7 col-xs-12" type="text" name="middle-name" placeholder="Apellido materno" value="<?php echo $ap_mat_socio; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" name="codigo_lealtad" class="form-control col-md-7 col-xs-12" placeholder="Codigo de Lealtad" onkeypress="return pulsar(event)"  value="<?php echo $codigo_lealtad; ?>">
                          </div>
                        </div>
                         <div class="form-group">
