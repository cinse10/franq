                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-4"></div>
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_socio.php" autocomplete="off">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" >Codigo Afiliado <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" name="codigo_lealtad" class="form-control col-md-7 col-xs-12" placeholder="Codigo Lealtad" onkeypress="return pulsar(event)"  value="<?php echo $codigo_lealtad; ?>">
                          </div>
                        </div>
                         <div class="form-group">
