          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ventas PROMOCIONES 3*2 Cklass</h3>
              </div>
            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_cklass` where inventario_producto != 0");
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_promo_cklass.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
  ...
  function efectivoTarjeta() {
    var final = Math.round(suma-saldo);
     ...
     alertify.confirm('Pago', '¿Método de pago?', 
      function(){ 
        muestra_total(final,chiquito);
      }
      , function(){ 
        muestra_tarjeta(final,chiquito);
    ...
    myWindow.document.write("<div class='ticket centrado'>");
      ...
      myWindow.document.write("<table><thead><tr><th class='producto'>PRODUCTO</th><th class='precio'>PRECIO</th></tr></thead>");
        myWindow.document.write("<tbody>");
          ...
          myWindow.document.write("<tr><td class='total'>Descuento: </td><td class='precio centrado total'>$ "+chiquito+"</td></tr>");
          myWindow.document.write("<tr><td class='total'>Total con Desc: </td><td class='precio centrado total'>$ "+suma+"</td></tr>");          
