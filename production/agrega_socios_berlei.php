                  ...
                  <div class="x_content">
                      <form id="agrega_socio" data-parsley-validate class="form-horizontal form-label-left" method="POST"  autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" id="codigo_lealtad" required="required" class="form-control col-md-7 col-xs-12" placeholder="Codigo de Lealtad" onkeypress="return pulsar(event)">
                          </div>
                        </div>
                         <div class="form-group">
  ...
  function enviaFormulario(e){
    ...
    $.ajax({
      ...
      data: {
          ...
          'whats_socio': whats_socio,
          'nacimiento_socio': nacimiento_socio,
          'calle_socio': calle_socio,
          'colonia_socio': colonia_socio,
          'municipio_socio': municipio_socio,
          'cp_socio': cp_socio,
          'email_socio': email_socio,
          'codigo_lealtad': codigo_lealtad,
          'id_empleado': id_de_empleado,
          'notas_socio': notas_socio,
          'bandera': 8
      },
...
<script type="text/javascript">
  function creaTicket(idticket){
   $.ajax({
        type: "POST",
        dataType: 'html',
        url: "trae_ticket.php",
        data: {'ticket': idticket, 'nuevo': true},
