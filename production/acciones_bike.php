			                      ...
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_producto_bike.php" enctype="multipart/form-data">
                                	...
                                	<br><br>
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input type="number" onkeyup='precios();' id="precio_compra" name="precio_compra" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $precio_compra; ?>">
				                        </div>
				                      </div>
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input type="text" id="precio_publico" name="precio_publico" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $precio_publico; ?>">
				                        </div>
				                      </div>
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input type="text" id="precio_publico_desc" name="precio_publico_desc" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $precio_publico_desc; ?>">
				                        </div>
				                      </div>
				                      <div class="form-group">
