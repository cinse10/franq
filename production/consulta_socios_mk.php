          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de socios Mary Kay</h3>
              </div>
            </div>
                                ...
                                include("conexion.php");
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                      ...
                                      echo "<tr>";
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios_mk.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
