 <?php 
  ...
  $kuerito =  "Select * from productos_of_vicky";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_of_vicky set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_of_vicky` WHERE inventario_producto!=0");
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_of_vicky.php",
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_of_vicky.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
  ...
  function Genera_ticketTDD(id_transaccion){
    ...
    $.ajax({
      type: "POST",
      url: "guarda_compra_of_vicky.php",
