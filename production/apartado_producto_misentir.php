<?php 
  ...
  $kuerito =  "Select * from productos_misentir";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_misentir set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                              ...
                              <?php 
                                  include("conexion.php");
                                  $productos = mysqli_query($conexion,"SELECT * FROM `productos_misentir` where inventario_producto != 0 ");
                                  while ($producto=mysqli_fetch_array($productos)) {
                                      ...
                                      echo '<option value="'.$id_producto.'" id="'.$id_producto.'">'.$nombre_producto.' /  '.$color_producto.' /  '.$rodada_producto.'</option>';
                                  }
                              ?>
                          </select>
                          <br><br><br>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "Select * from socios where id_socio = 1 or id_socio = 164 or id_socio = 249";
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_misentir.php",
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_misentir.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
...
function validaTransaccion(total,pagado,mini){
  ...
  function Genera_ticketTDD(pagado, total){
    ...
    $.ajax({
      type: "POST",
      url: "guarda_apartado_misentir.php",
