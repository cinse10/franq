            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="guarda_producto_berlei.php">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="modelo" required="required" class="form-control col-md-7 col-xs-12" placeholder="Modelo del producto">
	                        </div>
	                      </div>
	                      <div class="form-group">
