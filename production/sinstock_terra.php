          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Mundo Terra</h3>
              </div>
            </div>
                          ...
                          <table id="tablin" class="table table-striped table-bordered bulk_action">
                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito != 1) {
                                  $sql = "select * from productos_terra where inventario_producto = '0'";
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinStockTerra_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinStockTerra_"+fechita+".pdf"
