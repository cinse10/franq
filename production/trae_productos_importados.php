 <?php 
	...
	if ($_POST['codigo_barras']=="") {
		...
		$sql = "Select * from productos_importados where id_producto='".$codigo."'";
					...
					if ($row['inventario_tmp_producto']>0) {
						...
						if ($_POST['id_cliente']==1 ) {
							echo "<tr>";
									...
									echo "<td class='precio'>$ ".$row['precio_publico']."</td>";
									echo "<td class='precio'>$ ".$row['precio_publico']."</td>";							
									echo "<td><span class='glyphicon glyphicon-trash borrar'/></td>";
								 echo "</tr>";
							
						}elseif ($_POST['id_cliente']==4) {
							$precio_desc = ceil($row['precio_afiliado']-($row['precio_afiliado']*0.20)); 
									echo "<tr>
						...
						$kueri = "update productos_importados set inventario_tmp_producto=".$tmp_inventario." where id_producto=".$row['id_producto'];
