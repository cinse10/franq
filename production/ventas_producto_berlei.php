<?php 
  ...
  $kuerito =  "Select * from productos_berlei";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_berlei set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_berlei`");
                                    while ($producto=mysqli_fetch_array($productos)) {
                                        ...
                                        echo '<option value="'.$codigo_barras_producto.'" id="'.$id_producto.'">'.$modelo.'-'.$talla.'-'.$color.' /  '.$codigo_barras_producto.'</option>';
                                    }
                                ?>
                            </select>
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_berlei.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
  ...
  function traeSaldo(){
    $.ajax({
        ...
        data: {'id_cliente': cliente, 'marca': 15},  
