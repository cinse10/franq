            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "SELECT * FROM `socios_cklass`  WHERE id_socio!=71 AND id_socio!=24 AND id_socio!=31";
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_cklass_dev.php",
  ...
  function Genera_ticket(){
    $.ajax({
      type: "POST",
      url: "guarda_devoluciones_cklass.php",
