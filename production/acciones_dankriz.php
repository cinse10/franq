<?php 
	if (isset($_GET['id_producto'])&& isset($_GET['action'])) {
		...
		if ($action=="edita") {			
			...
			$sql = "select * from productos_dankriz WHERE id_producto=".$id_producto;
            ...
            while ($reg=mysqli_fetch_array($requi)) {
            	...
            	$precio_asociado = $reg['precio_clave'];
            	$precio_contado = $reg['precio_publico'];
            	$precio_credito = $reg['precio_afiliado'];
			            ...
			            <div class="row">
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  ...
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_producto_dankriz.php">
				                    ...
				                    <div class="form-group">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input name="precio_asociado" class="form-control col-md-7 col-xs-12" type="text"  required="required" value="<?php echo $precio_asociado; ?>">
				                        </div>
				                      </div> 
				                      <div class="form-group">
				                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Precio Contado <span class="required">*  $</span></label>
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input name="precio_contado" class="form-control col-md-7 col-xs-12" type="text"  required="required" value="<?php echo $precio_contado; ?>">
				                        </div>
				                      </div> 
				                      <div class="form-group">
