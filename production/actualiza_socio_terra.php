<?php 
	...
	if(mysqli_query($conexion,$SQL)){
			...
			echo $SQL2 = "UPDATE compras_terra SET monto_mensual='".$ventas."', tipo_desc=".$tipo_desc." WHERE id_socio=".$id_socio;
			die();
			if(mysqli_query($conexion,$SQL2)){
				echo '<script language="javascript">';
					echo 'alert("Socio actualizado con éxito.");';
					echo "window.location='consulta_socios_terra.php';";
				echo '</script>';
			}else{
				echo '<script language="javascript">';
					echo 'alert("Ocurrió un error al intentar guardar los datos1.");';
