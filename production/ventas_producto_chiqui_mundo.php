                            ...
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    ...
                                    while ($producto=mysqli_fetch_array($productos)) {
                                        ...
                                        $color_producto=$producto["descripcion"];
                                        $codigo_barras_producto=$producto["codigo_barras"];


                                        echo '<option value= "'.$id_producto.'">'.$nombre_producto.' - '.$codigo_producto.' - '.$color_producto.' /  '.$codigo_barras_producto.'</option>';
                                    }
                                ?>
                            </select>
...
<script type="text/javascript">
  ...
  function valida_empleado(){
    ...
    if (id_cliente==68 || id_cliente==79) {
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_chiqui.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
