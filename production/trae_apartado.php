<?php 
	...
	if (isset($_POST['id_ticket'])) {
		...
		while($ticket = mysqli_fetch_array($respuesta)){
			...
			echo "<tbody>";
			$kueri = "SELECT * FROM `transac_apartado_intima` INNER JOIN productos ON transac_apartado_intima.id_producto=productos.id_producto WHERE id_ticket=".$id_ticket;
			...
			if($renglones!=0){
				...
				echo "<tr><td class='total'>Anticipo: </td><td class='precio centrado total'>$ ".$ticket['total_abono']."</td></tr>";
