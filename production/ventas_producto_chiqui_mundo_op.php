 <?php 
  ...
  $kuerito =  "Select * from productos_chiqui_mundo";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ventas Ofertas Chiqui Mundo</h3>
              </div>
            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar()">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_chiqui_mundo` WHERE inventario_producto!=0");
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "SELECT * FROM `socios_chiqui_mundo`  WHERE id_socio!=71";
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_cklass_op.php",
      data: {"codigo_barras":codigo_barras, 'id_cliente': cliente },
      success: function(resp){
        console.log("respuesta tabla: "+resp);
        $('#tablita').append(resp);
        Limpiar();
        Cargar();
        Suma();
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_cklass_op.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
  ...
  function Genera_ticketTDD(id_transaccion){
    ...
    $.ajax({
      type: "POST",
      url: "guarda_compra_cklass_op.php",
