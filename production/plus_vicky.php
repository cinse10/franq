			            ...
			            <div class="row">
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  ...
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_producto_vicky_plus.php" enctype="multipart/form-data">
								  <div class="form-group">
				                    ...
				                    <div class="form-group">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input type="text" name="precio_catalogo" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $precio_catalogo; ?>"disabled>
				                        </div>
				                      </div>
				                      <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input type="text" name="precio_afiliado" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $precio_afiliado; ?>"disabled>
				                        </div>
				                      </div>
				                      <div class="form-group">
