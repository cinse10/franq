          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Productos Sin Stock Intima Hogar</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos where inventario_producto = '0' order by nombre_producto ASC";
...
<script src="js/jspdf.plugin.autotable.js"></script>
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SinstockIntima_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "SinstockIntima_"+fechita+".pdf"
