            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "Select * from socios id_socio!=408 AND id_socio!=410 AND id_socio!=411";
...
<script type="text/javascript">
  ...
  var nombre_cliente="# 164 CLIENTE PREFERENTE";
  var nombre_empleado="";
  var cliente=164;
