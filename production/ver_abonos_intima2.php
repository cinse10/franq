 <?php 
	...
	if (isset($_GET['id_ticket'])) {
		...
		$sql = "SELECT * FROM `apartado_intima`  INNER JOIN empleados ON apartado_intima.id_empledo=empleados.id_empleado WHERE id_ticket=".$id_ticket;
			              ...
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    ...
			                    <br>
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_producto_intima.php">
                                  ...
                                  <div class="col-md-3 col-sm-6 col-xs-12">
                                    <input type="text" name="tel" id="tel" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $telefono_cliente; ?>" disabled="disabled" >
				                      ...
				                      <div class="form-group">
				                        ...
				                        <button aligner ="right" type="button" class="btn btn-warning" onclick="creaTicket(0,0,0,0);" data-dismiss="modal">Imprimir ticket</button>
				                      <br><br>	
				                      <div class="col-md-12 col-sm-12 col-xs-12">
					                      <div class="x_panel">
					                        <div class="x_content">
					                      	    <table id="tabla_transc" align="center" class="table table-striped table-bordered bulk_action">
						                            ...
						                            <tbody>
						                              <?php 
						                                include("conexion.php");
						                                $sql2 = "SELECT * FROM `transac_apartado_intima` INNER JOIN productos ON transac_apartado_intima.id_producto=productos.id_producto WHERE id_ticket=".$id_ticket;
					                      ...
					                      <div class="x_panel">
                                            ...
                                            <th>Abono</th>
						                            ...
						                            <tbody>
						                              <?php 
						                                include("conexion.php");
						                                $sql3 = "SELECT * FROM `abonos_intima` WHERE id_ticket=".$id_ticket;
    ...
    myWindow.document.write("<div class='ticket centrado'>");
      ...
      myWindow.document.write("<table><thead><tr><th class='producto'>PRODUCTO</th><th class='precio'>PRECIO</th></tr></thead>");
        myWindow.document.write("<tbody>");
          ...
          myWindow.document.write("<tr><td class='total'>Total Abono: </td><td class='precio centrado total'>$ "+total_abono+"</td></tr>");
