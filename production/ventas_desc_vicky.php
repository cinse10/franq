<?php 
  ...
  $kuerito =  "Select * from productos_vicky_desc";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ventas Vicky Form OFERTA</h3>
              </div>
            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_vicky_desc`");
                                    while ($producto=mysqli_fetch_array($productos)) {
                                        $id_producto=$producto["id_producto"];
                                        $modelo_vf=$producto["modelo_vf"];
                                        $talla_vf=$producto["nombre"];
                                        $color_vf=$producto["color_vf"];
                                        $codigo_barras_producto=$producto["modelo_vf"];
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "SELECT * FROM `socios_vicky` WHERE id_socio!=175";
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_desc_vicky.php",
      data: {"modelo_vf":codigo_barras, 'id_cliente': cliente },
  ...
  function Cargar(){
    $('#datagrid').load('trae_desc_vicky.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
