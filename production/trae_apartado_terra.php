<?php 
	...
	$direccion="";
	$leyenda_inferior="";
	$sql = "select * from configuracion where id_configuracion = '6'";
	...
	if (isset($_POST['id_ticket'])) {
		...
		while($ticket = mysqli_fetch_array($respuesta)){
			...
			echo "<tbody>";
			$kueri = "SELECT * FROM `transac_apartado_terra` INNER JOIN productos_terra ON transac_apartado_terra.id_producto=productos_terra.id_producto WHERE id_ticket=".$id_ticket;
