          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de tickets Cklass Ofertas de Primavera</h3>
              </div>
            </div>
                          ...
                          <table id="tabla_tickets" class="table table-striped table-bordered bulk_action">
                            ...
                            <tbody>
                              <?php 
                                ...
                                $sql = "SELECT * FROM ((`tickets_cklass_op` INNER JOIN socios_cklass ON tickets_cklass_op.id_cliente = socios_cklass.id_socio) INNER JOIN empleados ON tickets_cklass_op.id_empledo=empleados.id_empleado) ORDER BY fecha_ticket DESC";
