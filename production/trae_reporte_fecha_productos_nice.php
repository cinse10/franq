<?php 
	...
	if (isset($_POST['fecha_inicio'])&&isset($_POST['fecha_fin'])) {
		...
		if ($_POST['id_empleado']==0) {
			$sql = "select * from tickets_nice INNER JOIN empleados ON tickets_nice.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_nice.id_cliente=socios.id_socio INNER JOIN transacciones_nice ON tickets_nice.id_ticket=transacciones_nice.id_ticket INNER JOIN productos_nice ON transacciones_nice.id_producto = productos_nice.id_producto where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'";	
		}else{
			$sql = "select * from tickets_nice INNER JOIN empleados ON tickets_nice.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_nice.id_cliente=socios.id_socio INNER JOIN transacciones_nice ON tickets_nice.id_ticket=transacciones_nice.id_ticket INNER JOIN productos_nice ON transacciones_nice.id_producto = productos_nice.id_producto where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' AND empleados.id_empleado=".$_POST['id_empleado'];	
		}
