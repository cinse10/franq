          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ventas Mundo Terra Descuento</h3>
              </div>
            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "SELECT * FROM `socios_terra` WHERE id_socio!=67 AND id_socio!=213";
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_terra_desc.php",
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_terra_desc.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
  ...
  function Genera_ticketTDD(id_transaccion){
    ...
    $.ajax({
      type: "POST",
      url: "guarda_compra_terra_desc.php",
