			                  ...
			                  <div class="x_title">
                                ...
                                if ($sub_linio==NULL || $sub_linio==0) {
                                   echo '<a  href="conector_linio\post_intima.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir a Linio</a>';
                                    ...
                                    echo '<a  href="conector_linio\put_intima.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Actualizar Linio</a>';
                                    
                                 }if ($ml_id==NULL) {
                                    echo '<a  href="conector_ml\conectIntima1.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir a Mercado Libre</a>';
                                  }else{
									echo '<a  href="conector_ml\descIntima.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir Descripcion ML</a>';
								  } 
								  echo '<a  href="conector_ml\actualiza_intima.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Actualiza ML</a>';
                                 ?>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_plus_intima.php" enctype="multipart/form-data">
                                	...
                                	<br><br>
									  ...
									  <div class="form-group">
				                        ...
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input name="codigo_sat" value="<?php echo $codigo_sat; ?>" class="form-control col-md-7 col-xs-12" type="text">
				                        </div>
				                      </div>
				                      <div class="form-group">
				                         	...
				                         	<?php 
				                          	switch ($tipo_producto) {
				                          		...
				                          		case "19405": 
											        ...
											        echo '<option value="19409">COBERTORES MANTAS Y COBIJAS</option>';
											        ...
											        echo '<option value="19178">CUBRE SALAS</option>          ';
				                          			break;
				                          		...
				                          		case "19409":
						                            ...
						                            echo '<option value="19406">SABANAS</option>';
						                            echo '<option value="19408">FUNDAS, ALMOHADAS Y COJINES</option>';
											        echo '<option value="19409" selected>COBERTORES MANTAS Y COBIJAS</option>';
											        echo '<option value="19410">EDREDON</option>';
											        echo '<option value="19411">PROTECTORES DE COLCHON</option>    ';
											        echo '<option value="19427">ALFOMBRAS Y TAPETES</option>          ';
											        echo '<option value="19431">CORTINAS</option>          ';
				                          		...
				                          		case "19178":
											        ...
											        echo '<option value="19391">TOALLAS DE BAÑO</option>          ';
											        echo '<option value="19392">BATAS DE BAÑO</option>          ';
													echo '<option value="19178" selected>CUBRE SALAS</option>          ';
				                          			break;
