<?php 
  ...
  $sql = "SELECT count(*) AS contador FROM base_cklass";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Valida inventario Cklass</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Productos</h2>
                    <a href="validar_inventario_cklass.php"  style="float: right;" class="btn btn-warning">Subir Inventario</a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="x_panel">
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                <?php 
                                    include("conexion.php");
                                    $kueri = "SELECT * FROM `base_cklass` INNER JOIN cklass ON base_cklass.id_cklass = cklass.id_cklass";
                                    $respuesta = mysqli_query($conexion,$kueri);
                                    while($producto = mysqli_fetch_array($respuesta)){
                                        echo "<tr>";
                                            echo "<td>".$producto['modelo_ck']."</td>";
                                            echo "<td>".$producto['color_ck']."</td>";
                                            echo "<td>".$producto['talla_ck']."</td>";
                                            echo "<td>".$producto['codigo_barras_producto']."</td>";                                            
                                            echo "<td>".$producto['precio_clave']."</td>";
                                            echo "<td>".$producto['precio_contado']."</td>";
                                            echo "<td>".$producto['precio_credito']."</td>";
