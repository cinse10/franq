 <?php 
  ...
  $kuerito =  "Select * from productos_betterware";
  ...
  while($productin = mysqli_fetch_array($respuesta)) {
    ...
    $kuerin = "update productos_betterware set inventario_tmp_producto=".$inventario_producto." where id_producto=".$id_producto;
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();" >
                            <select class="selectpicker"   data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras" >
                              ...
                              <?php 
                                  ...
                                  include("conexion.php");
                                  $productos = mysqli_query($conexion,"SELECT * FROM `productos_betterware` where inventario_producto != 0 ");
...
<script type="text/javascript">
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_better.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
