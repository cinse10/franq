          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Agregar Asociados</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      <form id="agrega_socio" data-parsley-validate class="form-horizontal form-label-left" method="POST"  autocomplete="off">
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nombre del asociado <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="nombre_socio" required="required" class="form-control col-md-7 col-xs-12" placeholder="Nombre del asociado" >
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" >Codigo de asociado <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="calle_socio" required="required" class="form-control col-md-7 col-xs-12" placeholder="Domicilio" onkeypress="return pulsar(event)">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Distribuidor<span class="required">   *  </span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                 <select class="form-control" name="dist_padre" id="dist_padre" required>
                                  <option value="">-- Selecciona Un distruibuidor --</option>
                                  <?php 
                                  ...
                                  while ($producto=mysqli_fetch_array($productos)) {
                                      ...
                                      $ape_p_dist_padre=$producto["ape_p_dist_padre"];
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" >Referido <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="ref_socio" required="required" class="form-control col-md-7 col-xs-12" placeholder="Cod. de asociada que refiere" onkeypress="return pulsar(event)">
                          </div>
                        </div>
                        <br>
                        <div class="form-group">
...
<script> 
  ...
  function enviaFormulario(ke){
    ...
    var ref_socio=document.getElementById("ref_socio").value;
    var email_socio=document.getElementById("email_socio").value;
    var dist_padre=document.getElementById("dist_padre").value;
    var tip_usuario=document.getElementById("tip_usuario").value;
    ...
    $.ajax({
      ...
      'calle_socio': calle_socio, 'ref_socio': ref_socio,
      'email_socio': email_socio, 'id_empleado': id_de_empleado,
      'cod_distribuidor': cod_distribuidor, 'dist_padre': dist_padre, 'tip_usuario': tip_usuario, 'bandera': 2},  
