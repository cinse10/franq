                            ...
                            <tbody>
                              <?php 
                                ...
                                if ($iddelempleadito != 1 && $iddelempleadito != 5) {
                                  $sql = "Select * from socios where (id_socio!=408 AND id_socio!=410 AND id_socio!=411 AND id_socio !=495) AND socios.id_empleado = $iddelempleadito or socios.id_empleado = 1";
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                      ...
                                      echo "<tr>";
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
