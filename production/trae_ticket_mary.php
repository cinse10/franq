<?php 
	...
	$direccion="";
	$leyenda_inferior="";
	$sql = "select * from configuracion where id_configuracion = '9'";
	...
	if (isset($_POST['id_ticket'])) {
		...
		$sql = "SELECT * FROM ((`tickets_marykay` INNER JOIN socios_mk ON tickets_marykay.id_cliente = socios_mk.id_socio) INNER JOIN empleados ON tickets_marykay.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
