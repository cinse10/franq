	...
	if (isset($_GET['id_producto'])) {
		$id_producto = $_GET['id_producto'];
            ...
            while ($reg=mysqli_fetch_array($requi)) {
            	...
            	$descripcion_producto = $reg['descripcion'];
            	$codigo_extra = $reg['codigo_producto'];
                $inventario = $reg['inventario_producto'];
            	$color_producto = $reg['color_producto'];
            	$tipo_producto = $reg['tipo_producto'];
            	$var_producto = $reg['talla_producto'];
			                ...
			                <div class="x_panel">
			                  <div class="x_title">
                                ...
                                if ($sub_linio==NULL || $sub_linio==0) {
                                   echo '<a  href="conector_linio\post_chiqui.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir a Linio</a>';
                                 } else{
                                    echo '<a  href="conector_linio\subir_imagen_chiqui.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir Imagenes a Linio</a>';
                                    echo '<a  href="conector_linio\put_chiqui.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Actualizar Linio</a>';
                                    
                                 }if ($ml_id==NULL) {
                                    echo '<a  href="conector_ml\conectChiqui.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir a Mercado Libre</a>';
                                  }else{
									echo '<a  href="conector_ml\descChiqui.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Subir Descripcion ML</a>';
								  } 
								  echo '<a  href="conector_ml\actualiza_chiqui.php?id_producto='.$id_producto.'" style="float: right;" class="btn btn-warning">Actualiza ML</a>';
                                 ?>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
			                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_plus_chiqui.php" enctype="multipart/form-data">
			                      	<div class="form-group">
				                      	<center>
				                      		<?php echo "<img src='chiquiMundo/".$uno."' width='80' height='80' alt=''>"; ?>
				                      		<br>
		                                ...
		                                <div class="col-md-6 col-sm-8 col-xs-8">
		                                    <?php echo "<img src='chiquiMundo/".$dos."' width='80' height='80' alt=''>"; ?>
		                                    <br>
	                                    ...
	                                    <div class="col-md-6 col-sm-8 col-xs-8">
	                                    	<?php echo "<img src='chiquiMundo/".$tres."' width='80' height='80' alt=''>"; ?>
	                                    	<br>
                                	...
                                	<br><br>
				                      ...
				                      <div class="form-group">
				                       ...
				                       <div class="form-group">
				                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Código Chiqui</label>
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                      ...
				                      <div class="form-group">
				                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Inventario</label>
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                          <input name="codigo_extra" value="<?php echo $inventario; ?>" class="form-control col-md-7 col-xs-12" type="text" disabled>
				                        </div>
				                      </div>
				                          	...
				                          	switch ($tipo_producto) {
				                          		...
				                          		case "19405":
													echo '<option value="">-Selecciona una opcion-</option>';
				                          			echo '<option value="19405" selected>CUNAS</option>';
						                            echo '<option value="19409">MANTAS Y COBIJAS</option>';
						                            echo '<option value="14716">ROPA DE CAMA</option>';
											        echo '<option value="15054">PAÑALERAS</option>';
											        echo '<option value="14483">PIJAMAS NIÑO</option>';
											        echo '<option value="14431">PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
											        echo '<option value="14470">CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927">LACTANCIA</option>          ';
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899">FAJAS MATERNIDAD</option>          ';
											        echo '<option value="15897">CONJUNTO MATERNIDAD</option>          ';
											        
				                          			break;
				                          		
				                          		case "19409":
													echo '<option value="" >-Selecciona una opcion-</option>';
                                                    echo '<option value="19405">CUNAS</option>';
				                          		...
				                          		case "14716":
                                                    ...
                                                    echo '<option value="19405">CUNAS</option>';
						                            echo '<option value="19409">MANTAS Y COBIJAS</option>';
						                            echo '<option value="14716" selected>ROPA DE CAMA</option>';
											        echo '<option value="15054">PAÑALERAS</option>';
											        echo '<option value="14483">PIJAMAS NIÑO</option>';
											        echo '<option value="14431">PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
				                          		...
				                          		case "15054":
						                            ...
						                            echo '<option value="19409">MANTAS Y COBIJAS</option>';
						                            echo '<option value="14716">ROPA DE CAMA</option>';
											        echo '<option value="15054" selected>PAÑALERAS</option>';
											        echo '<option value="14483">PIJAMAS NIÑO</option>';
											        echo '<option value="14431">PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
											        echo '<option value="14470">CHAMARAS PONCHOS</option>          ';
				                          		...
				                          		case "14483":
						                            ...
						                            echo '<option value="14716">ROPA DE CAMA</option>';
											        echo '<option value="15054">PAÑALERAS</option>';
											        echo '<option value="14483" selected>PIJAMAS NIÑO</option>';
											        echo '<option value="14431">PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
											        echo '<option value="14470">CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927">LACTANCIA</option>          ';
				                          		...
				                          		case "14431":
											        ...
											        echo '<option value="15054">PAÑALERAS</option>';
											        echo '<option value="14483">PIJAMAS NIÑO</option>';
											        echo '<option value="14431" selected>PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
											        echo '<option value="14470">CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927">LACTANCIA</option>          ';
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
				                          		...
				                          		case "14539":
											        ...
											        echo '<option value="14483">PIJAMAS NIÑO</option>';
											        echo '<option value="14431" >PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539" selected>BATAS DE BAÑO</option>          ';
											        echo '<option value="14470">CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927">LACTANCIA</option>          ';
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
				                          		...
				                          		case "14470":
											        ...
											        echo '<option value="14431" >PIJAMAS NIÑA</option>    ';
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
											        echo '<option value="14470" selected>CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927">LACTANCIA</option>          ';
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899">FAJAS MATERNIDAD</option>          ';
				                          		...
				                          		case "15927":
											        ...
											        echo '<option value="14539">BATAS DE BAÑO</option>          ';
											        echo '<option value="14470" >CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927" selected>LACTANCIA</option>          ';
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899">FAJAS MATERNIDAD</option>          ';
											        echo '<option value="15897">CONJUNTO MATERNIDAD</option>          ';
				                          		...
				                          		case "15923":
											        ...
											        echo '<option value="14470" >CHAMARAS PONCHOS</option>          ';
											        echo '<option value="15927">LACTANCIA</option>          ';
											        echo '<option value="15923" selected>BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899">FAJAS MATERNIDAD</option>          ';
											        echo '<option value="15897">CONJUNTO MATERNIDAD</option>          ';
				                          			break;
				                          		case "15915":
											        ...
											        echo '<option value="15927">LACTANCIA</option>          ';
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915" selected>CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899">FAJAS MATERNIDAD</option>          ';
											        echo '<option value="15897">CONJUNTO MATERNIDAD</option>          ';
				                          			break;
				                          		case "15899":
											        ...
											        echo '<option value="15923">BLUSAS MATERNIDAD</option>          ';
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899" selected>FAJAS MATERNIDAD</option>          ';
											        echo '<option value="15897">CONJUNTO MATERNIDAD</option>          ';
				                          			break;
				                          		case "15897":
													echo '<option value="">-Selecciona una opcion-</option>';
											        ...
											        echo '<option value="15915">CHAMARRAS MATERNIDAD</option>          ';
											        echo '<option value="15899">FAJAS MATERNIDAD</option>          ';
											        echo '<option value="15897" selected>CONJUNTO MATERNIDAD</option>          ';
				                          			break;
				                      ...
				                      <div id="bicicleta" class="form-group">
				                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="estilo_bike">Talla del producto<span class="required">   *  </span>
				                        </label>
				                        <div class="col-md-6 col-sm-6 col-xs-12">
				                         <select class="form-control" name="var_producto">
				                         	<?php 
				                          	switch ($var_producto) {
				                          		...
				                          		case "CHICA":
				                          			echo '<option value="CHICA" selected>CHICA</option>';
						                            echo '<option value="MEDIANA">MEDIANA</option>';
						                            echo '<option value="GRANDE">GRANDE</option>';
						                            echo '<option value="UNITALLA">UNITALLA</option>';
				                          			break;
				                          		
				                          		case "MEDIANA":
													echo '<option value="CHICA" >CHICA</option>';
						                            echo '<option value="MEDIANA" selected>MEDIANA</option>';
						                            echo '<option value="GRANDE">GRANDE</option>';
						                            echo '<option value="UNITALLA">UNITALLA</option>';
				                          			break;
				                          		...
				                          		case "UNITALLA":
						                            ...
						                            echo '<option value="MEDIANA">MEDIANA</option>';
						                            echo '<option value="GRANDE">GRANDE</option>';
						                            echo '<option value="UNITALLA" selected>UNITALLA</option>';
				                          			break;
