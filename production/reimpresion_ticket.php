                          ...
                          <table id="tabla_tickets" class="table table-striped table-bordered bulk_action">
                            ...
                            <tbody>
                              <?php 
                                ...
                                $sql = "SELECT * FROM ((`tickets_intima` INNER JOIN socios ON tickets_intima.id_cliente = socios.id_socio) INNER JOIN empleados ON tickets_intima.id_empledo=empleados.id_empleado) ORDER BY fecha_ticket DESC";
                                ...
                                while ($reg=mysqli_fetch_array($requi)) {
                                  echo "<tr>";
                                    ...
                                    ";
                                    echo "<a  href='devolucion_intima.php?id_ticket=".$reg["id_ticket"]."' class='btn btn-default btn-sm'><i class='fa fa-cut'></i></a>&nbsp";
   ...
   function manda_eliminar(id_ticket){
    ...
    $.ajax({
      ...
      success: function(data){ 
        ...
        window.location="reimpresion_ticket.php";
