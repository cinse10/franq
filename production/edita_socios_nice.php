...
if (isset($_GET['action']) && isset($_GET['id_socio'])) {
  ...
  $sql = "select * from socios_nice where id_socio=".$id_socio;
  ...
  if ($_GET['action']=="elimina") {
    ...
    echo '<script language="javascript">';
      ...
      if(mysqli_query($conexion,"delete from socios_nice where id_socio=".$id_socio)){
        echo 'alert("Socio eliminado con éxito.");';
      }else{
        echo 'alert("Ocurrió un error al intentar borrar los datos.");';
      }
      echo 'window.location="consulta_socios_nice.php";}else{';
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-4"></div>
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_socio_nice.php" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="nombre_socio"  class="form-control col-md-7 col-xs-12" placeholder="Nombre del socio" value="<?php echo $nombre_socio; ?>">
                          </div>
                        </div>
                         <div class="form-group">
