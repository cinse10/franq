<?php 
	...
	$sql = "SELECT * FROM ((`tickets_berlei` INNER JOIN socios_berlei ON tickets_berlei.id_cliente = socios_berlei.id_socio) INNER JOIN empleados ON tickets_berlei.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Devolución de Productos Berlei</h3>
      </div>
    </div>
                    ...
                    <tbody>
                      <?php 
                        ...
                        if (isset($_GET['id_ticket'])) {
							$id_ticket=$_GET['id_ticket'];
							$kueri = "SELECT * FROM `transacciones_berlei` INNER JOIN productos_berlei ON transacciones_berlei.id_producto=productos_berlei.id_producto WHERE id_ticket=".$id_ticket;
...
function eliminar(id_transaccion) {
   ...
   function manda_eliminar(id_transaccion){
    ...
    $.ajax({
      ...
      data: {'id_ticket': id_ticket, 'id_transaccion': id_transaccion, 'marca' : 15},  
