<?php 
	...
	if ($_POST['codigo_barras']=="") {
		...
		$sql = "Select * from productos_berlei where codigo_barras_producto='".$codigo."' or modelo='".$codigo."'";
			...
			while($row = mysqli_fetch_array($resp)) {
				if ($row['inventario_producto']>0) {
					if ($row['inventario_tmp_producto']>0) {		
						...
						$kueri = "update productos_berlei set inventario_tmp_producto=".$tmp_inventario." where id_producto=".$row['id_producto'];
