<?php 
	...
	if (isset($_POST['id_ticket'])) {
		...
		while($ticket = mysqli_fetch_array($respuesta)){
			...
			echo "<tbody>";
			$kueri = "SELECT * FROM `transac_apartado_misentir` INNER JOIN productos_misentir ON transac_apartado_misentir.id_producto=productos_misentir.id_producto WHERE id_ticket=".$id_ticket;
