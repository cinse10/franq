          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de socios Vicky Form</h3>
              </div>
            </div>
                                  ...
                                  while ($reg=mysqli_fetch_array($requi)) {
                                    $id_socio = $reg['id_socio'];
                                      ...
                                      echo "<tr>";
                                        ...
                                        $sql2 = "Select * from compras_vicky where compras_vicky.id_socio = $id_socio";
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios_vicky.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
