          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Mi sentir</h3>
              </div>
            </div>
                            ...
                            <table id="tablin" class="table table-striped table-bordered bulk_action">
                              <thead>
                                <tr>
                                  ...
                                  <th>Precio público con descuento</th>
                                  <th>Inventario</th>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_misentir order by nombre_producto ASC";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                        ...
                                        echo "<th>".$reg['descripcion_producto']."</th>";
                                        ...
                                        if($reportes==2){                                     
                                          echo "<th><a href='acciones_misentir.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp
                                          </th>";
                                        }else{
                                          echo "<th></th>";
                                        }
...
<script type="text/javascript">
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosMiSentir_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosMiSentir_"+fechita+".pdf"
