<?php 
	...
	if (isset($_POST['fecha_inicio'])&&isset($_POST['fecha_fin'])) {
		...
		if ($_POST['id_empleado']==0) {
			$sql = "select * from tickets_misentir INNER JOIN empleados ON tickets_misentir.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_misentir.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_misentir.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' UNION ALL select * from tickets INNER JOIN empleados ON tickets.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets.id_cliente=socios.id_socio INNER JOIN marcas ON tickets.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' UNION ALL select * from tickets_intima INNER JOIN empleados ON tickets_intima.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_intima.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_intima.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' UNION ALL select * from tickets_vicky INNER JOIN empleados ON tickets_vicky.id_empledo=empleados.id_empleado INNER JOIN socios_vicky ON tickets_vicky.id_cliente=socios_vicky.id_socio INNER JOIN marcas ON tickets_vicky.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' UNION ALL select * from tickets_terra INNER JOIN empleados ON tickets_terra.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_terra.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_terra.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' UNION ALL select * from tickets_cklass INNER JOIN empleados ON tickets_cklass.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_cklass.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_cklass.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59' UNION ALL select * from tickets_nice INNER JOIN empleados ON tickets_nice.id_empledo=empleados.id_empleado INNER JOIN socios ON tickets_nice.id_cliente=socios.id_socio INNER JOIN marcas ON tickets_nice.id_marca=marcas.id_marca where fecha_ticket between'".$inicio." 00:00:00' AND '".$fin." 23:59:59'";
		}else{
