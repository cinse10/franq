                        ...
                        <div class="form-group" >
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();" >
                            <select class="selectpicker"  data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `productos_terra` WHERE inventario_producto!=0");
...
<script type="text/javascript">
  ...
  function valida_empleado(){
    ...
    if (id_cliente==30 || id_cliente==246) {
  ...
  function Cargar(){
    $('#datagrid').load('trae_productos_terra.php');    
  }
  function Limpiar(){
    $("#codigo_barras").val("");
  }
