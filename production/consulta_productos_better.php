          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta productos Betterware</h3>
              </div>
            </div>
                              ...
                              <tbody>
                                <?php 
                                  include("conexion.php");
                                    ...
                                    $sql = "select * from productos_betterware order by nombre_producto ASC";
                                    ...
                                    while ($reg=mysqli_fetch_array($requi)) {
                                      echo "<tr>";
                                        ...
                                        echo "<th>$ ".$reg['precio_compra']."</th>";
                                        echo "<th>".$reg['inventario_producto']."</th>";
                                        echo "<th>".$reg['codigo_producto']."</th>";
                                  
                                        echo "<th><a href='acciones_better.php?action=edita&id_producto=".$reg['id_producto']."'><i class='glyphicon glyphicon-pencil'></i></a>
                                          </th>";
...
<script src="js/jspdf.plugin.autotable.js"></script>
  ...
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'ProductosBetterware_'+fechita+'.xls';
...
function HazCotizacion(id_cotizacion) {
        ...
        var salto_linea = 70;
            ...
            doc.text("Betterware",X+300,Y-50);
            ...
            function(dispose) {
                    ...
                    var nombre_cotizacion= "ProductosBetterware_"+fechita+".pdf"
