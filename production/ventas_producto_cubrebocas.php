                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12" onclick="Registrar();">
                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="codigo_barras" name="codigo_barras">
                                ...
                                <?php 
                                    include("conexion.php");
                                    $productos = mysqli_query($conexion,"SELECT * FROM `cubrebocas` WHERE inventario_producto!=0 ");
                                    while ($producto=mysqli_fetch_array($productos)) {
                                        ...
                                        echo '<option value="'.$codigo_barras_producto.'" id="'.$id_producto.'">'.$nombre.'-'.$talla.'-'.$color.' /  '.$codigo_barras_producto.'</option>';
                                    }
                                ?>
                            </select>
...
<script type="text/javascript">
  ...
  function Registrar(){
    ...
    $.ajax({
      type: "POST",
      dataType: 'html',
      url: "trae_productos_cubrebocas.php",
  ...
  function Genera_ticketTDD(id_transaccion){
    ...
    $.ajax({
      type: "POST",
      url: "guarda_compra_cubrebocas.php",
