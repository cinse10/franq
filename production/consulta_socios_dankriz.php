          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Consulta de socios Dankriz</h3>
              </div>
            </div>
                                    ...
                                    $id_socio = $reg['id_socio'];
                                      ...
                                      echo "<tr>";
                                        ...
                                        if ($reg['id_empleado']==4) 
                                          echo "<th>Cklass</th>";
                                        $sql2 = "Select * from compras_dankriz where compras_dankriz.id_socio = $id_socio";
                                        ...
                                        if($socios==2){                                    
                                          echo "<th><a href='edita_socios_dankriz.php?action=edita&id_socio=".$reg['id_socio']."'><i class='glyphicon glyphicon-pencil'></i></a>&nbsp&nbsp&nbsp";
                                          echo "</th>";
...
<script type="text/javascript">
  function exportTableToExcel(tabla, filename = ''){
      ...
      // Specify file name
      filename = filename?filename+'.xls':'SociosCklass_'+fechita+'.xls';
