...
if (isset($_GET['action']) && isset($_GET['id_socio'])) {
  ...
  $sql = "select * from socios_cklass where id_socio=".$id_socio;
  ...
  $sql2 = "select * from compras_cklass where id_socio=".$id_socio;
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-4"></div>
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="actualiza_socio_cklass.php" autocomplete="off">
