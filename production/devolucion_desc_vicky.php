<?php 
	...
	$sql = "SELECT * FROM ((`tickets_desc_vicky` INNER JOIN socios_vicky ON tickets_desc_vicky.id_cliente = socios_vicky.id_socio) INNER JOIN empleados ON tickets_desc_vicky.id_empledo=empleados.id_empleado) WHERE id_ticket=".$id_ticket;
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Devolución de Productos Vicky Form</h3>
      </div>
    </div>
                        ...
                        if (isset($_GET['id_ticket'])) {
							...
							if($renglones!=0){
								...
								while($producto = mysqli_fetch_array($respuesta2)){
									echo "<tr>";
										echo "<th>".$producto['descripcion_vf']."</th>";
...
function eliminar(id_transaccion) {
   ...
   function manda_eliminar(id_transaccion){
    ...
    $.ajax({
      ...
      data: {'id_ticket': id_ticket, 'id_transaccion': id_transaccion, 'marca' : 5},  
