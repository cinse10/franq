            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="socio" id="socio">
                  ...
                  <?php 
                    include("conexion.php");
                    $sql = "Select * from socios where id_socio = 1 or id_socio = 164 or id_socio = 249 or id_socio = 411 or id_socio = 703";
...
<script type="text/javascript">
  ...
  function efectivoTarjeta() {
    ...
    var pagado=0;
    //var mini = total - (total*0.10);
    var mini = (10/100)*total;
