          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Inventario Chuiqui Mundo</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Hacer inventario</h2>
                    <a href="checa_inventario_chiqui.php"  style="float: right;" class="btn btn-warning">Validar Inventario</a>
...
<script type="text/javascript">
    ...
    function ValidaProducto() {
        ...
        $.ajax({
            type: "POST",
            dataType: 'html',
            url: "guarda_inventario.php",
            data: {'codigo': codigo, 'marca' : 12}, 
