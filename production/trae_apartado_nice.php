<?php 
	...
	$direccion="";
	$leyenda_inferior="";
	$sql = "select * from configuracion where id_configuracion = '8'";
	...
	if (isset($_POST['id_ticket'])) {
		...
		while($ticket = mysqli_fetch_array($respuesta)){
			...
			echo "<tbody>";
			$kueri = "SELECT * FROM `transac_apartado_nice` INNER JOIN productos_nice ON transac_apartado_nice.id_producto=productos_nice.id_producto WHERE id_ticket=".$id_ticket;
