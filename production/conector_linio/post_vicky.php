    ...
    include("../conexion.php");
        $id_producto = $_GET['id_producto'];
            ...
            while ($reg=mysqli_fetch_array($requi)) {
                ...
                if ($reg['codigo_barras_producto'] == NULL) {
                    $var_producto = '';  
                }else{
                    $var_producto = $reg['codigo_barras_producto'];  
                }
    ...
    $request_xml = '<?xml version="1.0" encoding="UTF-8" ?>
                    <Request>
                      <Product>
                        ...
                        <Name>'.$descripcion_vf.'- VICKYFORM</Name>
                        <Variation>'.$talla_vf.'</Variation>
                        ...
                        <ProductData>                     
                            ...
                            <PackageContent>Contiene: 1 '.$descripcion_vf.'</PackageContent>
                            <ShortDescription><![CDATA['.$detalles_linio.']]></ShortDescription>
                            <Color>'.$color_vf.'</Color>
                            <Model>'.$modelo_vf.'</Model>
                            <ProductMeasures>'.$anchura.' x '.$altura.' x '.$longitud.'</ProductMeasures>
                            <FilterColor>'.$color_vf.'</FilterColor>
                        </ProductData>
                      </Product>
                    </Request>
    ';
