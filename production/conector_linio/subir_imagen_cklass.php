                        ...
                        $request_xml = '<?xml version="1.0" encoding="UTF-8" ?>
                                        <Request>
                                            <ProductImage>
                                                ...
                                                <Images>
                                                    <Image>http://13.59.1.71/franq/production/cklass/'.$uno.'</Image>
                                                    <Image>http://13.59.1.71/franq/production/cklass/'.$dos.'</Image>
                                                    <Image>http://13.59.1.71/franq/production/cklass/'.$tres.'</Image>
                                                </Images>
                                            </ProductImage>
                                        </Request>   
