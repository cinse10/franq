                    ...
                    $request_xml = '<?xml version="1.0" encoding="UTF-8" ?>
                                    <Request>
                                        <ProductImage>
                                            ...
                                            <Images>
                                                <Image>http://3.15.38.22/franq/production/intima/'.$uno.'</Image>
                                                <Image>http://3.15.38.22/franq/production/intima/'.$dos.'</Image>
                                                <Image>http://3.15.38.22/franq/production/intima/'.$tres.'</Image>
                                            </Images>
                                        </ProductImage>
                                    </Request>   
